...
const config = {
  title: 'Bridge',
  tagline:
    'Apache Bridge is a modern data exploration and visualization platform',
  url: 'https://bridge.apache.org',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  plugins: [
    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          {
            to: '/docs/installation/installing-bridge-using-docker-compose',
  ...
  themeConfig:
    ...
    ({
      ...
      algolia: {
        ...
        indexName: 'bridge-apache',
      },
      navbar: {
        logo: {
          alt: 'Bridge Logo',
          src: 'img/bridge-logo-horiz.svg',
          srcDark: 'img/bridge-logo-horiz-dark.svg',
        },
        items: [
          {
            label: 'Documentation',
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Slack',
                href: 'https://join.slack.com/t/apache-bridge/shared_invite/zt-1jp6hjzrq-H0PlFtToyLWuPiJDuRWCNw',
              },
              {
                label: 'Mailing List',
                href: 'https://lists.apache.org/list.html?dev@bridge.apache.org',
              },
              {
                label: 'Stack Overflow',
                href: 'https://stackoverflow.com/questions/tagged/bridge+apache-bridge',
              },
            ],
          },
          {
      ...
      footer: {
        ...
        <small>Apache Bridge, Apache, Bridge, the Bridge logo, and the Apache feather logo are either registered trademarks or trademarks of The Apache Software Foundation. All other products or name brands are trademarks of their respective holders, including The Apache Software Foundation.
