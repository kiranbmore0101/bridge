...
contained in
[requirements.txt](https://github.com/apache/bridge/blob/master/requirements.txt) and
[requirements-dev.txt](https://github.com/apache/bridge/blob/master/requirements-dev.txt)
