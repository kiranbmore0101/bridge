...
The PyAthena library also allows to assume a specific IAM role, by [importing the datasource from YAML](https://bridge.apache.org/docs/miscellaneous/importing-exporting-datasources/#importing-datasources-from-yaml) and passing extra parameters:
```
databases:
