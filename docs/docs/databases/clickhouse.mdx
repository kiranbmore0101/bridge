...
To use ClickHouse with Bridge, you will need to add the following Python library:

```
clickhouse-connect>=0.4.1
```

If running Bridge using Docker Compose, add the following to your `./docker/requirements-local.txt` file:
