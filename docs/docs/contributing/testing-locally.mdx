...
Then update `BRIDGE__SQLALCHEMY_EXAMPLES_URI` to point to local Presto cluster:

```bash
export BRIDGE__SQLALCHEMY_EXAMPLES_URI=presto://localhost:15433/memory/default
```
