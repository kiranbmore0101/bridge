...
const links = [
  [
    'https://join.slack.com/t/apache-bridge/shared_invite/zt-1jp6hjzrq-H0PlFtToyLWuPiJDuRWCNw',
    'Slack',
  ...
  [
    'https://lists.apache.org/list.html?dev@bridge.apache.org',
    'dev@ Mailing List',
  ...
  [
    ...
    'Bridge Community Calendar',
    'join us for working group sessions and other community gatherings',
  ],
  [
    'https://stackoverflow.com/questions/tagged/bridge+apache-bridge',
    'Stack Overflow',
    'our growing knowledge base',
  ],
  [
    'https://www.meetup.com/Global-Apache-Bridge-Community-Meetup/',
    'Bridge Meetup Group',
  ...
  [
    'https://github.com/apache-bridge/awesome-apache-bridge',
    'Contributors Guide',
