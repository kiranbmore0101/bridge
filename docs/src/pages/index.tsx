...
import { bridgeTheme } from '@bridge-ui/style';
...
export default function Home(): JSX.Element {
  ...
  return (
    <Layout
      title="Welcome"
      description="Community website for Apache Bridge, a data visualization and data exploration platform"
    >
      <StyledMain>
        <StyledTitleContainer>
            <img className="logo-horiz" src="img/bridge-logo-horiz-apache.svg" alt="logo-horiz" />
            <div className="info-text">
              Apache Bridge is a modern data exploration and visualization
              platform
            </div>
        ...
        <StyledFeatures>
            ...
            <div className="info-text info-text-smaller">
              Bridge is fast, lightweight, intuitive, and loaded with options
              ...
              <Row>
                ...
                <Col sm={24} md={12}>
                  <Feature
                    ...
                    descr={`
                    Bridge can connect to any SQL based datasource
              ...
              <Row>
                <Col sm={24} md={12}>
                  <Feature
                    ...
                    descr={`
                    Bridge is lightweight and highly scalable, leveraging the
                ...
                <Col sm={24} md={12}>
                  <Feature
                    ...
                    descr={`
                    Bridge ships with a wide array of beautiful visualizations.
                    Our visualization plug-in architecture makes it easy to build
                    custom visualizations that drop directly into Bridge.
                  `}
                  />
                </Col>
              </Row>
