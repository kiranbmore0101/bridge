...
/**
 * This type defines all available extensions of Bridge's default UI.
 * Namespace the keys here to follow the form of 'some_domain.functonality.item'.
 * Take care to name your keys well, as the name describes what this extension point's role is in Bridge.
 *
...
/**
 * A registry containing extensions which can alter Bridge's UI at specific points defined by Bridge.
 * See SIP-87: https://github.com/kiranbmore0101/bridge/issues/20615
 */
