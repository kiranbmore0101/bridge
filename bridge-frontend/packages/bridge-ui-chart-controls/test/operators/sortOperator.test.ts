...
import { sortOperator } from '@bridge-ui/chart-controls';
import * as bridgeCoreModule from '@bridge-ui/core';
...
test('should ignore the sortOperator', () => {
  // FF is disabled
  Object.defineProperty(bridgeCoreModule, 'hasGenericChartAxes', {
    value: false,
  });
