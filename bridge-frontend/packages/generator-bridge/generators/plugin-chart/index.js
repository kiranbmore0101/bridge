    ...
    this.answers = await this.prompt([
      {
        ...
        // Default to current folder name, e.g. bridge-plugin-chart-hello-world
      ...
      },
      {
        ...
        // Hello World
        default: _.startCase(
          _.camelCase(this.appname.replace('bridge plugin chart', '').trim()),
        ),
      },
      {
        type: 'input',
        name: 'description',
        message: 'Description:',
        // Bridge Plugin Chart Hello World
