...
import { ensureIsArray, styled } from '@bridge-ui/core';
...
const StyledDiv = styled.div`
  ${({ theme }) => `
    .bridge-legacy-chart-horizon {
      overflow: auto;
      position: relative;
    }

    .bridge-legacy-chart-horizon .horizon-row {
    ...
    .bridge-legacy-chart-horizon .horizon-row span.title {
      position: absolute;
