...
export const WORLD_HEALTH_DASHBOARD = '/bridge/dashboard/world_health/';
export const SAMPLE_DASHBOARD_1 = '/bridge/dashboard/1-sample-dashboard/';
export const SUPPORTED_CHARTS_DASHBOARD =
  '/bridge/dashboard/supported_charts_dash/';
export const TABBED_DASHBOARD = '/bridge/dashboard/tabbed_dash/';
