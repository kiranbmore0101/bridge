...
describe('Visualization > Area', () => {
  beforeEach(() => {
    cy.preserveLogin();
    cy.intercept('POST', '/bridge/explore_json/**').as('getJson');
  });
  ...
  it('should allow type to search color schemes and apply the scheme', () => {
    ...
    cy.get('.Control[data-test="color_scheme"] input[type="search"]')
      .focus()
      .type('bridgeColors{enter}');
    cy.get(
      '.Control[data-test="color_scheme"] .ant-select-selection-item [data-test="bridgeColors"]',
    ).should('exist');
