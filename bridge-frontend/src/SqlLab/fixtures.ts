...
import { DatasourceType, QueryResponse, QueryState } from '@bridge-ui/core';
...
export const queries = [
  ...
  },
  {
    ...
    executedSql:
      ...
      'cache_timeout, perm\nFROM bridge.slices) AS inner_qry \n LIMIT 1000',
...
const baseQuery: QueryResponse = {
  ...
  tempTable: 'temp',
  userId: 1,
  executedSql: 'SELECT * FROM bridge.slices',
  rows: 42,
  started: 'started',
  queryLimit: 100,
  endDttm: 1476910566798,
