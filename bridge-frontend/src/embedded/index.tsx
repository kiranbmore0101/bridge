...
import { makeApi, t, logging } from '@bridge-ui/core';
...
//   throw new Error(
//     `[bridge] iframe parent ${parentOrigin} is not in the list of allowed origins`,
//   );
// }
 ...
 * 401 errors from the api and BridgeClient will call this function.
 */
...
/**
 * Configures BridgeClient with the correct settings for the embedded dashboard page.
 */
