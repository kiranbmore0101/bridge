 ...
 * under the License.
 */
import { JsonObject, BridgeClientResponse, t } from '@bridge-ui/core';
import {
  BridgeError,
  ErrorTypeEnum,
...
// BridgeClientResponse object, and can contain a spread JSON blob
...
export function getClientErrorObject(
  ...
  // takes a BridgeClientResponse as input, attempts to read response as Json if possible,
