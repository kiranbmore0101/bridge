...
const versionInfoStyles = (theme: BridgeTheme) => css`
...
const styledDisabled = (theme: BridgeTheme) => css`
  color: ${theme.colors.grayscale.base};
...
const tagStyles = (theme: BridgeTheme) => css`
  color: ${theme.colors.grayscale.light5};
`;

const styledChildMenu = (theme: BridgeTheme) => css`
  &:hover {
...
const RightMenu = ({
  ...
  const canSql = findPermission('can_sqllab', 'Bridge', roles);
...
// Bridge still has multiple entry points, and not all of them have
