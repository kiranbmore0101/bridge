...
import { BridgeClient, t, styled } from '@bridge-ui/core';
...
function SavedQueryList({
  ...
  const openNewQuery = () => {
    window.open(`${window.location.origin}/bridge/sqllab?new=true`);
  };
  ...
  const openInSqlLab = (id: number) => {
    window.open(`${window.location.origin}/bridge/sqllab?savedQueryId=${id}`);
  };
