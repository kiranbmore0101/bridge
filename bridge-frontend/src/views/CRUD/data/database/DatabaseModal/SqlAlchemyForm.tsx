...
const SqlAlchemyTab = ({
  ...
  if (BridgeText) {
    fallbackDocsUrl =
      BridgeText.DB_MODAL_SQLALCHEMY_FORM?.SQLALCHEMY_DOCS_URL;
    fallbackDisplayText =
      BridgeText.DB_MODAL_SQLALCHEMY_FORM?.SQLALCHEMY_DISPLAY_TEXT;
  } else {
  ...
  return (
    <>
      ...
      <Button
        ...
        cta
        buttonStyle="link"
        css={(theme: BridgeTheme) => wideButton(theme)}
      >
        {t('Test connection')}
      </Button>
    </>
