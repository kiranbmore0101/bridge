  ...
  const renderAvailableSelector = () => (
    <div className="available">
      ...
      <Alert
        showIcon
        closable={false}
        css={(theme: BridgeTheme) => antDAlertStyles(theme)}
        type="info"
        message={
      ...
      <StyledFooterButton
        ...
        tooltip={
          db?.is_managed_externally
            ? t(
                "This database is managed externally, and can't be edited in Bridge",
              )
            : ''
        }
      >
    ...
    <StyledBtns>
      ...
      <Button
        ...
        onClick={() => {
          setLoading(true);
          fetchAndSetDB();
          window.location.href = `/bridge/sqllab/?db=true`;
        }}
      >
          ...
          {useSqlAlchemyForm ? (
            <StyledAlignment>
              ...
              {isDynamic(db?.backend || db?.engine) && !isEditMode && (
                <div css={(theme: BridgeTheme) => infoTooltip(theme)}>
                  <Button
                    buttonStyle="link"
                    onClick={() =>
                      setDB({
