...
import { css, styled, BridgeTheme } from '@bridge-ui/core';
...
export const labelMarginBotton = (theme: BridgeTheme) => css`
  margin-bottom: ${theme.gridUnit * 2}px;
`;

export const marginBottom = (theme: BridgeTheme) => css`
...
export const antdCollapseStyles = (theme: BridgeTheme) => css`
  .ant-collapse-header {
...
export const infoTooltip = (theme: BridgeTheme) => css`
...
export const toggleStyle = (theme: BridgeTheme) => css`
  padding-left: ${theme.gridUnit * 2}px;
`;

export const formScrollableStyles = (theme: BridgeTheme) => css`
  padding: ${theme.gridUnit * 4}px ${theme.gridUnit * 4}px 0;
`;

export const antDModalStyles = (theme: BridgeTheme) => css`
  .ant-select-dropdown {
...
export const antDAlertStyles = (theme: BridgeTheme) => css`
...
export const antDErrorAlertStyles = (theme: BridgeTheme) => css`
...
export const antdWarningAlertStyles = (theme: BridgeTheme) => css`
...
export const formHelperStyles = (theme: BridgeTheme) => css`
  .required {
...
export const wideButton = (theme: BridgeTheme) => css`
  width: 100%;
...
export const formStyles = (theme: BridgeTheme) => css`
  .form-group {
    margin-bottom: ${theme.gridUnit * 4}px;
    &-w-50 {
...
export const validatedFormStyles = (theme: BridgeTheme) => css`
  label {
    color: ${theme.colors.grayscale.dark1};
    font-size: ${theme.typography.sizes.s}px;
    margin-bottom: 0;
...
export const buttonLinkStyles = (theme: BridgeTheme) => css`
  font-weight: ${theme.typography.weights.normal};
  text-transform: initial;
  padding-right: ${theme.gridUnit * 2}px;
`;

export const importDbButtonLinkStyles = (theme: BridgeTheme) => css`
...
export const alchemyButtonLinkStyles = (theme: BridgeTheme) => css`
  font-weight: ${theme.typography.weights.normal};
  text-transform: initial;
