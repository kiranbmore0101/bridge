...
const createFetchResourceMethod =
  ...
  async (filterValue = '', page: number, pageSize: number) => {
    ...
    const { json = {} } = await BridgeClient.get({
...
export const getRecentAcitivtyObjs = (
  ...
  BridgeClient.get({ endpoint: recent }).then(recentsRes => {
    const res: any = {};
    const filters = [
      {
        col: 'created_by',
...
export const StyledIcon = (theme: BridgeTheme) => css`
