...
import { getExtensionsRegistry } from '@bridge-ui/core';
...
const recentActivityEndpoint = 'glob:*/bridge/recent_activity/*';
...
describe('Welcome', () => {
  ...
  it('calls api methods in parallel on page load', () => {
    ...
    const recentCall = fetchMock.calls(/bridge\/recent_activity\/*/);
