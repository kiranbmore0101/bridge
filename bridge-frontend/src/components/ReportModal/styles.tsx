...
import { styled, css, BridgeTheme } from '@bridge-ui/core';
...
export const TimezoneHeaderStyle = (theme: BridgeTheme) => css`
  margin: ${theme.gridUnit * 3}px 0 ${theme.gridUnit * 2}px;
`;

export const SectionHeaderStyle = (theme: BridgeTheme) => css`
