...
import { BridgeTheme, css } from '@bridge-ui/core';
import {
  Styles,
  Theme,
...
import { BridgeStyledSelectProps } from './DeprecatedSelect';
...
const colors = (theme: BridgeTheme) => ({
...
export const defaultTheme: (theme: BridgeTheme) => PartialThemeConfig =
  theme => ({
...
export type InputProps = ReactSelectInputProps & {
  ...
  autoComplete?: string;
  onPaste?: BridgeStyledSelectProps<OptionType>['onPaste'];
  inputStyle?: object;
};
