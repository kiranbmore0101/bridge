...
export type BridgeStyledSelectProps<
...
>(SelectComponent: SelectComponentType) {
  type SelectProps = BridgeStyledSelectProps<OptionType>;
  ...
  const bridgeDefaultComponents: SelectComponentsConfig<OptionType> =
    DEFAULT_COMPONENTS;
  ...
  /**
   * Bridge styled `Select` component. Apply Bridge themed stylesheets and
  ...
  function StyledSelect(selectProps: SelectProps) {
    ...
    const {
      // additional props for Bridge Select
      selectRef,
      labelKey = 'label',
      valueKey = 'value',
      themeConfig,
    ...
    const MaybeSortableSelect = shouldAllowSort
      ...
      : SelectComponent;
    const components = { ...bridgeDefaultComponents, ...components_ };
    ...
    return (
      <MaybeSortableSelect
        ...
        // merge default theme from `react-select`, default theme for Bridge,
