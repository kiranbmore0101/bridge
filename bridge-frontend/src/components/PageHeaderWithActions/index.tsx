...
import { css, BridgeTheme, t, useTheme } from '@bridge-ui/core';
...
export const menuTriggerStyles = (theme: BridgeTheme) => css`
...
const headerStyles = (theme: BridgeTheme) => css`
  display: flex;
  flex-direction: row;
  align-items: center;
  flex-wrap: nowrap;
...
const buttonsStyles = (theme: BridgeTheme) => css`
  display: flex;
  align-items: center;
...
const additionalActionsContainerStyles = (theme: BridgeTheme) => css`
