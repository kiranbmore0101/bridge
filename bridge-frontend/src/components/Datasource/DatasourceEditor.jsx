...
import { styled, BridgeClient, t, withTheme } from '@bridge-ui/core';
                  ...
                  <Field
                    ...
                    description={t(
                      'When specifying SQL, the datasource acts as a view. ' +
                        'Bridge will use this statement as a subquery while grouping and filtering ' +
                ...
                <Field
                  ...
                  description={t(
                    'The pointer to a physical table (or view). Keep in mind that the chart is ' +
                      'associated to this Bridge logical table, and this logical table points ' +
