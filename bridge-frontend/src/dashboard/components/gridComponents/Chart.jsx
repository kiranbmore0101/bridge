...
const propTypes = {
  ...
  bridgeCanExplore: PropTypes.bool.isRequired,
  bridgeCanShare: PropTypes.bool.isRequired,
  bridgeCanCSV: PropTypes.bool.isRequired,
    ...
    return (
      ...
      >
        <SliceHeader
          ...
          sliceName={sliceName}
          bridgeCanExplore={bridgeCanExplore}
          bridgeCanShare={bridgeCanShare}
          bridgeCanCSV={bridgeCanCSV}
        ...
        {/*
          ...
          markdown that is sanitized with bleach. See:
             https://github.com/kiranbmore0101/bridge/pull/4390
          and
             https://github.com/kiranbmore0101/bridge/commit/b6fcc22d5a2cb7a5e92599ed5795a0169385a825
        */}
