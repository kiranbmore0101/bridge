...
class Header extends React.PureComponent {
  ...
  overwriteDashboard() {
    ...
    const limit =
      dashboardInfo.common.conf.BRIDGE_DASHBOARD_POSITION_DATA_LIMIT ||
      DASHBOARD_POSITION_DATA_LIMIT;
  ...
  render() {
    ...
    const userCanSaveAs =
      ...
      filterboxMigrationState !== FILTER_BOX_MIGRATION_STATES.REVIEWING;
    const userCanCurate =
      isFeatureEnabled(FeatureFlag.EMBEDDED_BRIDGE) &&
      findPermission('can_set_embedded', 'Dashboard', user.roles);
    const refreshLimit =
      dashboardInfo.common?.conf?.BRIDGE_DASHBOARD_PERIODICAL_REFRESH_LIMIT;
