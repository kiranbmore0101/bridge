...
export interface SliceHeaderControlsProps {
  ...
  bridgeCanExplore?: boolean;
  bridgeCanShare?: boolean;
  bridgeCanCSV?: boolean;
  ...
  render() {
    ...
    const menu = (
      ...
      >
        ...
        {(slice.description || this.props.bridgeCanExplore) && (
          <Menu.Divider />
        )}
