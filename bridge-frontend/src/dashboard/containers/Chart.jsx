...
function mapStateToProps(
  ...
  return {
    ...
    timeout: dashboardInfo.common.conf.BRIDGE_WEBSERVER_TIMEOUT,
    filters: getActiveFilters() || EMPTY_OBJECT,
    formData,
    editMode: dashboardState.editMode,
    isExpanded: !!dashboardState.expandedSlices[id],
    bridgeCanExplore: !!dashboardInfo.bridge_can_explore,
    bridgeCanShare: !!dashboardInfo.bridge_can_share,
    bridgeCanCSV: !!dashboardInfo.bridge_can_csv,
