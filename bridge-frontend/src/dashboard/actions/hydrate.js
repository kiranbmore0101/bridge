...
import { Behavior, getChartMetadataRegistry } from '@bridge-ui/core';
    ...
    return dispatch({
      ...
      data: {
        ...
        dashboardInfo: {
          ...
          dash_save_perm: findPermission('can_save_dash', 'Bridge', roles),
          dash_share_perm: findPermission(
            'can_share_dashboard',
            'Bridge',
            roles,
          ),
          bridge_can_explore: findPermission(
            'can_explore',
            'Bridge',
            roles,
          ),
          bridge_can_share: findPermission(
            'can_share_chart',
            'Bridge',
            roles,
          ),
          bridge_can_csv: findPermission('can_csv', 'Bridge', roles),
          slice_can_edit: findPermission('can_slice', 'Bridge', roles),
          common: {
