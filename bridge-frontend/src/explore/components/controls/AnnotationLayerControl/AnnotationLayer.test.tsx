...
import { getChartMetadataRegistry, ChartMetadata } from '@bridge-ui/core';
...
beforeAll(() => {
  ...
  fetchMock.get('glob:*/bridge/user_slices*', [
...
test('renders chart options', async () => {
  ...
  userEvent.click(screen.getByText('Bridge annotation'));
