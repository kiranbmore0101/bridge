...
export function getAnnotationJsonUrl(slice_id, form_data, isNative, force) {
  ...
  return uri
    .pathname(`/bridge/${endpoint}/${slice_id}`)
    .search({
...
export const exportChart = ({
  ...
  BridgeClient.postForm(url, { form_data: safeStringify(payload) });
};
...
export const exploreChart = (formData, requestParams) => {
  ...
  BridgeClient.postForm(url, { form_data: safeStringify(formData) });
};
