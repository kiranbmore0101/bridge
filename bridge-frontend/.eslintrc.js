  ...
  overrides: [
    ...
    },
    {
      files: [
        ...
        'Stories.tsx',
        'packages/bridge-ui-core/src/style/index.tsx',
      ],
      rules: {
    ...
    'no-restricted-imports': [
      'warn',
      {
        paths: [
          ...
          {
            name: '@bridge-ui/core',
            importNames: ['bridgeTheme'],
            message:
              'Please use the theme directly from the ThemeProvider rather than importing bridgeTheme.',
          },
        ],
      },
    ],
