...
# Contributing to the Bridge Embedded SDK

The bridge-embedded-sdk directory is a self contained sub-project in the Bridge codebase.

This is because the SDK has different requirements from other parts of the Bridge codebase:
...
what happens if bridge is offline
what happens if the bridge domain is invalid or incorrect
