...
PACKAGE_JSON = os.path.join(BASE_DIR, "bridge-frontend", "package.json")
...
VERSION_INFO_FILE = os.path.join(BASE_DIR, "bridge", "static", "version_info.json")
...
setup(
    ...
    zip_safe=False,
    entry_points={
        "console_scripts": ["bridge=bridge.cli.main:bridge"],
    ...
    author_email="dev@bridge.apache.org",
    url="https://bridge.apache.org/",
    download_url="https://www.apache.org/dist/bridge/" + version_string,
    classifiers=[
