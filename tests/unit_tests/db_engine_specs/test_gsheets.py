...
def test_validate_parameters_simple() -> None:
    from bridge.db_engine_specs.gsheets import (
        GSheetsEngineSpec,
...
def test_validate_parameters_catalog(
    ...
    g = mocker.patch("bridge.db_engine_specs.gsheets.g")
    g.user.email = "admin@example.com"

    create_engine = mocker.patch("bridge.db_engine_specs.gsheets.create_engine")
