...
def test_odbc_impersonation() -> None:
    ...
    from bridge.db_engine_specs.drill import DrillEngineSpec
...
def test_invalid_impersonation() -> None:
    ...
    from bridge.db_engine_specs.drill import DrillEngineSpec
    from bridge.db_engine_specs.exceptions import BridgeDBAPIProgrammingError

    url = URL("drill+foobar")
    username = "DoAsUser"

    with raises(BridgeDBAPIProgrammingError):
