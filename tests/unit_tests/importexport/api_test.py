...
def test_export_assets(
    ...
    ExportAssetsCommand = mocker.patch("bridge.importexport.api.ExportAssetsCommand")
...
def test_import_assets(
    ...
    ImportAssetsCommand = mocker.patch("bridge.importexport.api.ImportAssetsCommand")
                    ...
                    "issue_codes": [
                        {
                            "code": 1010,
                            "message": (
                                "Issue 1010 - Bridge encountered an error while "
                                "running a command."
                            ),
                        }
                    ]
