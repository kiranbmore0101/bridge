...
from bridge.utils.date_parser import (
    DateRangeMigration,
    datetime_eval,
    get_past_or_future,
    get_since_until,
...
@patch("bridge.utils.date_parser.parse_human_datetime", mock_parse_human_datetime)
...
@patch("bridge.utils.date_parser.datetime")
