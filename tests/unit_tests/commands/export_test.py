...
def test_export_assets_command(mocker: MockFixture) -> None:
    ...
    ExportDatabasesCommand = mocker.patch(
        "bridge.commands.export.assets.ExportDatabasesCommand"
    )
    ...
    ExportDatasetsCommand = mocker.patch(
        "bridge.commands.export.assets.ExportDatasetsCommand"
    )
    ...
    ExportChartsCommand = mocker.patch(
        "bridge.commands.export.assets.ExportChartsCommand"
    )
    ...
    ExportDashboardsCommand = mocker.patch(
        "bridge.commands.export.assets.ExportDashboardsCommand"
    )
    ...
    ExportSavedQueriesCommand = mocker.patch(
        "bridge.commands.export.assets.ExportSavedQueriesCommand"
    )
