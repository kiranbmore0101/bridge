...
from bridge.exceptions import QueryClauseValidationException
from bridge.sql_parse import (
    add_table_name,
...
def test_insert_rls(
    ...
    mocker.patch("bridge.sql_parse.get_rls_for_table", new=get_rls_for_table)
...
def test_extract_table_references(mocker: MockerFixture) -> None:
    ...
    logger = mocker.patch("bridge.sql_parse.logger")
    ...
    logger = mocker.patch("bridge.migrations.shared.utils.logger")
    sql = "SELECT * FROM table UNION ALL SELECT * FROM other_table"
