...
if TYPE_CHECKING:
    from bridge.databases.schemas import DatabaseParametersSchemaMixin
...
def dummy_engine(mocker: MockFixture) -> None:
    ...
    mocker.patch("bridge.databases.schemas.get_engine_spec", return_value=DummyEngine)
...
def test_database_parameters_schema_mixin(
    ...
    from bridge.models.core import ConfigurationMethod
...
def test_rename_encrypted_extra() -> None:
    ...
    """
    from bridge.databases.schemas import ConfigurationMethod, DatabasePostSchema
