...
from bridge.utils.core import DatasourceName, GenericDataType
...
class TestPrestoDbEngineSpec(TestDbEngineSpec):
    ...
    @mock.patch("bridge.db_engine_specs.base.BaseEngineSpec.get_table_names")
    @mock.patch("bridge.db_engine_specs.presto.PrestoEngineSpec.get_view_names")
    ...
    @mock.patch("bridge.db_engine_specs.base.BaseEngineSpec.select_star")
    ...
    @mock.patch("bridge.db_engine_specs.presto.is_feature_enabled")
    @mock.patch("bridge.db_engine_specs.base.BaseEngineSpec.select_star")
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            BridgeError(
                ...
                error_type=BridgeErrorType.COLUMN_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            BridgeError(
                ...
                error_type=BridgeErrorType.TABLE_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            BridgeError(
                ...
                error_type=BridgeErrorType.SCHEMA_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            BridgeError(
                ...
                error_type=BridgeErrorType.CONNECTION_ACCESS_DENIED_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            BridgeError(
                ...
                error_type=BridgeErrorType.CONNECTION_HOST_DOWN_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            BridgeError(
                ...
                error_type=BridgeErrorType.CONNECTION_UNKNOWN_DATABASE_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
