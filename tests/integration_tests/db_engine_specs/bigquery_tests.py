...
class TestBigQueryDbEngineSpec(TestDbEngineSpec):
    ...
    @mock.patch("bridge.db_engine_specs.bigquery.BigQueryEngineSpec.get_engine")
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            BridgeError(
                ...
                error_type=BridgeErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR,
    ...
    @mock.patch("bridge.models.core.Database.db_engine_spec", BigQueryEngineSpec)
