...
from bridge.utils.core import GenericDataType
...
class TestPostgresDbEngineSpec(TestDbEngineSpec):
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            BridgeError(
                error_type=BridgeErrorType.CONNECTION_INVALID_USERNAME_ERROR,
...
psql: error: could not connect to server: Operation timed out
        ...
        assert result == [
            BridgeError(
                error_type=BridgeErrorType.CONNECTION_INVALID_PASSWORD_ERROR,
