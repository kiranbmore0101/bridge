...
from bridge.db_engine_specs.hive import HiveEngineSpec, upload_to_s3
from bridge.exceptions import BridgeException
from bridge.sql_parse import Table, ParsedQuery
...
@mock.patch("bridge.db_engine_specs.hive.g", spec={})
def test_df_to_sql_if_exists_fail(mock_g):
    mock_g.user = True
    mock_database = mock.MagicMock()
    mock_database.get_df.return_value.empty = False
    with pytest.raises(BridgeException, match="Table already exists"):
        HiveEngineSpec.df_to_sql(
...
@mock.patch("bridge.db_engine_specs.hive.g", spec={})
@mock.patch("bridge.db_engine_specs.hive.upload_to_s3")
...
@mock.patch("bridge.db_engine_specs.base.BaseEngineSpec.fetch_data")
...
@mock.patch("bridge.db_engine_specs.hive.HiveEngineSpec._latest_partition_from_df")
...
@mock.patch("bridge.db_engine_specs.presto.PrestoEngineSpec.latest_partition")
