...
from bridge.db_engine_specs import load_engine_specs
...
from bridge.db_engine_specs.sqlite import SqliteEngineSpec
...
class TestDbEngineSpecs(TestDbEngineSpec):
    ...
    @mock.patch("bridge.models.core.Database.db_engine_spec", BaseEngineSpec)
