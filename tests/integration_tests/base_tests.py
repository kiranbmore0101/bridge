...
def post_assert_metric(
    ...
    :param client: test client for bridge api requests
    ...
    """
    with patch.object(
        BaseBridgeModelRestApi, "incr_stats", return_value=None
    ) as mock_method:
...
class BridgeTestCase(TestCase):
    ...
    def get_birth_names_dataset() -> SqlaTable:
        return BridgeTestCase.get_table(name="birth_names")
    ...
    def get_table(
        ...
        return (
            ...
            .filter_by(
                ...
                or BridgeTestCase.get_database_by_name("examples").id,
                schema=schema,
                table_name=name,
            )
            .one()
    ...
    def run_sql(
        ...
        dbid = BridgeTestCase.get_database_by_name(database_name).id
        json_payload = {
            "database_id": dbid,
            "sql": sql,
            "client_id": client_id,
