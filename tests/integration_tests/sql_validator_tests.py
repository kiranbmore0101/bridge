...
from bridge.sql_validators import SQLValidationAnnotation
from bridge.sql_validators.base import BaseSQLValidator
from bridge.sql_validators.postgres import PostgreSQLValidator
from bridge.sql_validators.presto_db import (
...
class TestSqlValidatorEndpoint(BridgeTestCase):
    ...
    @patch("bridge.views.core.get_validator_by_name")
    @patch.dict(
        "bridge.config.SQL_VALIDATORS_BY_ENGINE",
        PRESTO_SQL_VALIDATORS_BY_ENGINE,
        clear=True,
...
class TestBaseValidator(BridgeTestCase):
...
class TestPrestoValidator(BridgeTestCase):
...
class TestPostgreSQLValidator(BridgeTestCase):
