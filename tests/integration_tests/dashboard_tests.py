...
class TestDashboard(BridgeTestCase):
    @pytest.fixture
    ...
    def test_bridge_dashboard_url(self):
        url_for("Bridge.dashboard", dashboard_id_or_slug=1)
    ...
    def test_new_dashboard(self):
        ...
        group = re.match(
            r"http:\/\/localhost\/bridge\/dashboard\/([0-9]*)\/\?edit=true",
    ...
    def test_save_dash(self, username="admin"):
        ...
        url = "/bridge/save_dash/{}/".format(dash.id)
    ...
    def test_copy_dash(self, username="admin"):
        ...
        dash_id = dash.id
        url = "/bridge/save_dash/{}/".format(dash_id)
        ...
        url = "/bridge/copy_dash/{}/".format(dash_id)
    ...
    def test_add_slices(self, username="admin"):
        ...
        url = "/bridge/add_slices/{}/".format(dash.id)
    ...
    def test_public_user_dashboard_access(self):
        ...
        self.assertNotIn("/bridge/dashboard/births/", resp)
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertIn("/bridge/dashboard/births/", resp)
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertNotIn("/bridge/dashboard/world_health/", resp)
    ...
    def test_dashboard_with_created_by_can_be_accessed_by_public_users(self):
        ...
        res: Response = self.client.get("/bridge/dashboard/births/")
    ...
    def test_users_can_list_published_dashboard(self):
        self.login("alpha")
        resp = self.get_resp("/api/v1/dashboard/")
        assert f"/bridge/dashboard/{pytest.hidden_dash_slug}/" not in resp
        assert f"/bridge/dashboard/{pytest.published_dash_slug}/" in resp
    ...
    def test_users_can_view_own_dashboard(self):
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertIn(f"/bridge/dashboard/{my_dash_slug}/", resp)
        self.assertNotIn(f"/bridge/dashboard/{not_my_dash_slug}/", resp)
    ...
    def test_users_can_view_favorited_dashboards(self):
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertIn(f"/bridge/dashboard/{fav_dash_slug}/", resp)
    ...
    def test_user_can_not_view_unpublished_dash(self):
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        self.assertNotIn(f"/bridge/dashboard/{slug}/", resp)
