...
from bridge.reports.models import ReportScheduleType
from bridge.tasks.scheduler import execute, scheduler
...
@patch("bridge.tasks.scheduler.execute.apply_async")
...
@pytest.mark.usefixtures("owners")
@patch("bridge.tasks.scheduler.is_feature_enabled")
@patch("bridge.tasks.scheduler.execute.apply_async")
...
@pytest.mark.usefixtures("owners")
@patch("bridge.reports.commands.execute.AsyncExecuteReportScheduleCommand.__init__")
@patch("bridge.reports.commands.execute.AsyncExecuteReportScheduleCommand.run")
@patch("bridge.tasks.scheduler.execute.update_state")
def test_execute_task(update_state_mock, command_mock, init_mock, owners):
    from bridge.reports.commands.exceptions import ReportScheduleUnexpectedError
