...
class TestExportChartsCommand(BridgeTestCase):
...
class TestImportChartsCommand(BridgeTestCase):
    @patch("bridge.charts.commands.importers.v1.utils.g")
...
class TestChartsCreateCommand(BridgeTestCase):
    @patch("bridge.utils.core.g")
    @patch("bridge.charts.commands.create.g")
    @patch("bridge.security.manager.g")
    @pytest.mark.usefixtures("load_energy_table_with_slice")
...
class TestChartsUpdateCommand(BridgeTestCase):
    @patch("bridge.charts.commands.update.g")
    @patch("bridge.utils.core.g")
    @patch("bridge.security.manager.g")
    @pytest.mark.usefixtures("load_energy_table_with_slice")
