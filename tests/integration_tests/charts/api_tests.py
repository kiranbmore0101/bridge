...
from bridge.extensions import cache_manager, db
from bridge.models.core import Database, FavStar, FavStarClassName
...
class TestChartApi(BridgeTestCase, ApiOwnersTestCaseMixin, InsertChartMixin):
    resource_name = "chart"
    ...
    def test_update_chart(self):
        ...
        birth_names_table_id = BridgeTestCase.get_table(name="birth_names").id
