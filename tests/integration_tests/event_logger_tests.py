...
class TestEventLogger(unittest.TestCase):
    ...
    def test_log_this(self, mock_log):
        ...
        with app.test_request_context("/bridge/dashboard/1/?myparam=foo"):
            result = test_func()
            ...
            self.assertEqual(
                ...
                [
                    {
                        "myparam": "foo",
                        "path": "/bridge/dashboard/1/",
                        "url_rule": "/bridge/dashboard/<dashboard_id_or_slug>/",
    ...
    @patch("bridge.utils.core.g", spec={})
