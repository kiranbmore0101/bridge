...
from bridge.connectors.sqla.models import SqlaTable, TableColumn, SqlMetric
from bridge.constants import EMPTY_STRING, NULL_STRING
from bridge.db_engine_specs.bigquery import BigQueryEngineSpec
from bridge.db_engine_specs.druid import DruidEngineSpec
from bridge.exceptions import QueryObjectValidationError, BridgeSecurityException
...
class TestDatabaseModel(BridgeTestCase):
    ...
    @patch("bridge.models.core.Database.db_engine_spec", BigQueryEngineSpec)
