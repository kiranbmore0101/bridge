...
def _create_world_bank_slices(table: SqlaTable) -> List[Slice]:
    from bridge.examples.world_bank import create_slices
...
def _create_world_bank_dashboard(table: SqlaTable) -> Dashboard:
    from bridge.examples.helpers import update_slice_ids
    from bridge.examples.world_bank import dashboard_positions
