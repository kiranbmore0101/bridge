...
from bridge import app, appbuilder, db, security_manager, viz
...
class TestRolePermission(BridgeTestCase):
    ...
    def test_gamma_user_schema_access_to_dashboards(self):
        ...
        self.assertIn("/bridge/dashboard/world_health/", data)
        self.assertNotIn("/bridge/dashboard/births/", data)
    ...
    def assert_can_gamma(self, perm_set):
        ...
        self.assertIn(("can_add_slices", "Bridge"), perm_set)
        self.assertIn(("can_copy_dash", "Bridge"), perm_set)
        self.assertIn(("can_created_dashboards", "Bridge"), perm_set)
        self.assertIn(("can_created_slices", "Bridge"), perm_set)
        self.assertIn(("can_csv", "Bridge"), perm_set)
        self.assertIn(("can_dashboard", "Bridge"), perm_set)
        self.assertIn(("can_explore", "Bridge"), perm_set)
        self.assertIn(("can_share_chart", "Bridge"), perm_set)
        self.assertIn(("can_share_dashboard", "Bridge"), perm_set)
        self.assertIn(("can_explore_json", "Bridge"), perm_set)
        self.assertIn(("can_fave_dashboards", "Bridge"), perm_set)
        self.assertIn(("can_fave_slices", "Bridge"), perm_set)
        self.assertIn(("can_save_dash", "Bridge"), perm_set)
        self.assertIn(("can_slice", "Bridge"), perm_set)
        self.assertIn(("can_explore_json", "Bridge"), perm_set)
    ...
    def assert_can_alpha(self, perm_set):
        ...
        self.assertIn(("can_import_dashboards", "Bridge"), perm_set)
    ...
    def assert_can_admin(self, perm_set):
        ...
        self.assertIn(("can_override_role_permissions", "Bridge"), perm_set)
        self.assertIn(("can_override_role_permissions", "Bridge"), perm_set)
        self.assertIn(("can_approve", "Bridge"), perm_set)
    ...
    def test_is_admin_only(self):
        ...
        self.assertTrue(
            security_manager._is_admin_only(
                security_manager.find_permission_view_menu("can_approve", "Bridge")
            )
        )

    @unittest.skipUnless(
        BridgeTestCase.is_module_installed("pydruid"), "pydruid not installed"
    )
    ...
    def test_sql_lab_permissions(self):
        ...
        self.assertIn(("can_csv", "Bridge"), sql_lab_set)
        self.assertIn(("can_read", "Database"), sql_lab_set)
        self.assertIn(("can_read", "SavedQuery"), sql_lab_set)
        self.assertIn(("can_sql_json", "Bridge"), sql_lab_set)
        self.assertIn(("can_sqllab_viz", "Bridge"), sql_lab_set)
        self.assertIn(("can_sqllab_table_viz", "Bridge"), sql_lab_set)
        self.assertIn(("can_sqllab", "Bridge"), sql_lab_set)
    ...
    def test_granter_permissions(self):
        ...
        self.assertIn(("can_override_role_permissions", "Bridge"), granter_set)
        self.assertIn(("can_approve", "Bridge"), granter_set)
    ...
    def test_gamma_permissions(self):
        ...
        self.assertIn(("can_add_slices", "Bridge"), gamma_perm_set)
        self.assertIn(("can_copy_dash", "Bridge"), gamma_perm_set)
        self.assertIn(("can_created_dashboards", "Bridge"), gamma_perm_set)
        self.assertIn(("can_created_slices", "Bridge"), gamma_perm_set)
        self.assertIn(("can_csv", "Bridge"), gamma_perm_set)
        self.assertIn(("can_dashboard", "Bridge"), gamma_perm_set)
        self.assertIn(("can_explore", "Bridge"), gamma_perm_set)
        self.assertIn(("can_share_chart", "Bridge"), gamma_perm_set)
        self.assertIn(("can_share_dashboard", "Bridge"), gamma_perm_set)
        self.assertIn(("can_explore_json", "Bridge"), gamma_perm_set)
        self.assertIn(("can_fave_dashboards", "Bridge"), gamma_perm_set)
        self.assertIn(("can_fave_slices", "Bridge"), gamma_perm_set)
        self.assertIn(("can_save_dash", "Bridge"), gamma_perm_set)
        self.assertIn(("can_slice", "Bridge"), gamma_perm_set)
...
class TestSecurityManager(BridgeTestCase):
    """
    Testing the Security Manager.
    """

    @patch("bridge.security.BridgeSecurityManager.raise_for_access")
    def test_can_access_datasource(self, mock_raise_for_access):
        ...
        mock_raise_for_access.side_effect = BridgeSecurityException(
            BridgeError(
                "dummy",
                BridgeErrorType.DATASOURCE_SECURITY_ACCESS_ERROR,
                ErrorLevel.ERROR,
            )
        )
    ...
    def test_can_access_table(self, mock_raise_for_access):
        ...
        mock_raise_for_access.side_effect = BridgeSecurityException(
            BridgeError(
                "dummy", BridgeErrorType.TABLE_SECURITY_ACCESS_ERROR, ErrorLevel.ERROR
            )
        )

        self.assertFalse(security_manager.can_access_table(database, table))

    @patch("bridge.security.BridgeSecurityManager.is_owner")
    @patch("bridge.security.BridgeSecurityManager.can_access")
    @patch("bridge.security.BridgeSecurityManager.can_access_schema")
    def test_raise_for_access_datasource(
        ...
        with self.assertRaises(BridgeSecurityException):
            security_manager.raise_for_access(datasource=datasource)
...
class TestAccessRequestEndpoints(BridgeTestCase):
...
class TestDatasources(BridgeTestCase):
    @patch("bridge.security.manager.g")
    @patch("bridge.security.BridgeSecurityManager.can_access_database")
    @patch("bridge.security.BridgeSecurityManager.get_session")
...
class TestGuestTokens(BridgeTestCase):
    ...
    @patch("bridge.security.BridgeSecurityManager._get_current_epoch_time")
