...
from bridge.dao.exceptions import (
    DAOCreateFailedError,
    DAODeleteFailedError,
    DAOUpdateFailedError,
)
from bridge.datasets.models import Dataset
from bridge.extensions import db, security_manager
...
from bridge.utils.dict_import_export import export_to_dict
...
class TestDatasetApi(BridgeTestCase):
    ...
    @patch("bridge.models.core.Database.get_columns")
    @patch("bridge.models.core.Database.has_table_by_name")
    @patch("bridge.models.core.Database.has_view_by_name")
    @patch("bridge.models.core.Database.get_table")
    ...
    @patch("bridge.datasets.dao.DatasetDAO.create")
    ...
    @patch("bridge.datasets.dao.DatasetDAO.update")
    ...
    @patch("bridge.datasets.dao.DatasetDAO.delete")
