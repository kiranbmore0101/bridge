...
from bridge.datasets.commands.importers import v0, v1
...
class TestExportDatasetsCommand(BridgeTestCase):
...
class TestImportDatasetsCommand(BridgeTestCase):
    ...
    @patch("bridge.datasets.commands.importers.v1.utils.g")
    @pytest.mark.usefixtures("load_energy_table_with_slice")
