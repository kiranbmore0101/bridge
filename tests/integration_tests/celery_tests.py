...
# under the License.
# isort:skip_file
"""Unit tests for Bridge Celery worker"""
import datetime
import random
import string
import time
...
from bridge.sql_parse import ParsedQuery, CtasMethod
...
def test_default_data_serialization():
    ...
    results = BridgeResultSet(SERIALIZATION_DATA, CURSOR_DESCR, db_engine_spec)
