...
from tests.integration_tests.bridge_test_custom_template_processors import (
...
DEBUG = False
BRIDGE_WEBSERVER_PORT = 8081
SILENCE_FAB = False
# Allowing SQLALCHEMY_DATABASE_URI and SQLALCHEMY_EXAMPLES_URI to be defined as an env vars for
# continuous integration
if "BRIDGE__SQLALCHEMY_DATABASE_URI" in os.environ:
    SQLALCHEMY_DATABASE_URI = os.environ["BRIDGE__SQLALCHEMY_DATABASE_URI"]

SQLALCHEMY_EXAMPLES_URI = SQLALCHEMY_DATABASE_URI
if "BRIDGE__SQLALCHEMY_EXAMPLES_URI" in os.environ:
    SQLALCHEMY_EXAMPLES_URI = os.environ["BRIDGE__SQLALCHEMY_EXAMPLES_URI"]
...
if "sqlite" in SQLALCHEMY_DATABASE_URI:
    logger.warning(
        ...
        "removed in a future version of Bridge."
    )
...
DATA_CACHE_CONFIG = {
    **CACHE_CONFIG,
    ...
    "CACHE_KEY_PREFIX": "bridge_data_cache",
}
