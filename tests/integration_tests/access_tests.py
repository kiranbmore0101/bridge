...
from bridge.utils.core import get_user_id, get_username, override_user
...
EXTEND_ROLE_REQUEST = (
    "/bridge/approve?datasource_type={}&datasource_id={}&"
...
class TestRequestAccess(BridgeTestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_override_role_permissions_is_admin_only(self):
        ...
        response = self.client.post(
            "/bridge/override_role_permissions/",
    ...
    @mock.patch("bridge.utils.core.send_mime_email")
    def test_approve(self, mock_send_mime):
        if app.config["ENABLE_ACCESS_REQUEST"]:
            ...
            self.assertEqual(
                "[Bridge] Access to the datasource {} was granted".format(
    ...
    def test_request_access(self):
        if app.config["ENABLE_ACCESS_REQUEST"]:
            ...
            ROLE_GRANT_LINK = (
                '<a href="/bridge/approve?datasource_type={}&datasource_id={}&'
...
def test_get_user_id(
    ...
    mock_g = mocker.patch("bridge.utils.core.g", spec={})
