...
from bridge.explore.exceptions import DatasetAccessDeniedError
...
@patch("bridge.security.BridgeSecurityManager.can_access_datasource")
...
@patch("bridge.datasource.dao.DatasourceDAO.get_datasource")
