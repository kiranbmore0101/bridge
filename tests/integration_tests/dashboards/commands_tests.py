...
from bridge.dashboards.commands.export import (
    append_charts,
    ExportDashboardsCommand,
    get_default_position,
)
from bridge.dashboards.commands.importers import v0, v1
...
class TestExportDashboardsCommand(BridgeTestCase):
    @pytest.mark.usefixtures("load_world_bank_dashboard_with_slices")
    @patch("bridge.security.manager.g")
    @patch("bridge.views.base.g")
    ...
    @pytest.mark.usefixtures("load_world_bank_dashboard_with_slices")
    @patch("bridge.dashboards.commands.export.suffix")
...
class TestImportDashboardsCommand(BridgeTestCase):
    ...
    @patch("bridge.dashboards.commands.importers.v1.utils.g")
