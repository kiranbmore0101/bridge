...
from bridge.key_value.models import KeyValueEntry
...
def permalink_salt() -> Iterator[str]:
    from bridge.key_value.shared_entries import get_permalink_salt, get_uuid_namespace
    from bridge.key_value.types import SharedKey
...
@patch("bridge.security.BridgeSecurityManager.raise_for_dashboard_access")
