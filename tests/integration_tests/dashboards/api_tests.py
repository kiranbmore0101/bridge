...
from bridge.models.core import FavStar, FavStarClassName
...
class TestDashboardApi(BridgeTestCase, ApiOwnersTestCaseMixin, InsertChartMixin):
        ...
        expected_results = [
            {
                ...
                "url": "/bridge/dashboard/create_slug1/",
            },
            {
                "dashboard_title": "create_title0",
                "url": "/bridge/dashboard/create_slug0/",
            },
        ]
    ...
    def test_delete_dashboard_not_owned(self):
        ...
        user_alpha1 = self.create_user(
            "alpha1", "password", "Alpha", email="alpha1@bridge.org"
        )
        user_alpha2 = self.create_user(
            "alpha2", "password", "Alpha", email="alpha2@bridge.org"
        )
        existing_slice = (
