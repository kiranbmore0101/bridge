...
from bridge.exceptions import BridgeErrorsException
from bridge.reports.models import ReportRecipientType
from bridge.reports.notifications.base import BaseNotification
from bridge.reports.notifications.exceptions import NotificationError
from bridge.utils.core import HeaderDataType, send_email_smtp
from bridge.utils.decorators import statsd_gauge
from bridge.utils.urls import modify_url_query
...
class EmailNotification(BaseNotification):  # pylint: disable=too-few-public-methods
    ...
    def _get_content(self) -> EmailContent:
        ...
        call_to_action = __("Explore in Bridge")
        url = (
