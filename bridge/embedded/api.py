...
from bridge.dashboards.schemas import EmbeddedDashboardResponseSchema
...
from bridge.reports.logs.schemas import openapi_spec_methods_override
from bridge.views.base_api import BaseBridgeModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class EmbeddedDashboardRestApi(BaseBridgeModelRestApi):
