...
from bridge import event_logger, is_feature_enabled, security_manager
...
from bridge.views.base import BaseBridgeView, common_bootstrap_payload


class EmbeddedView(BaseBridgeView):
