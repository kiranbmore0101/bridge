...
from bridge.dataframe import df_to_records
from bridge.db_engine_specs import BaseEngineSpec
from bridge.errors import ErrorLevel, BridgeError, BridgeErrorType
from bridge.exceptions import BridgeErrorException, BridgeErrorsException
...
from bridge.sql_parse import CtasMethod, insert_rls, ParsedQuery
...
from bridge.utils.decorators import stats_timing
...
def handle_query_error(
    ...
    if isinstance(ex, BridgeErrorException):
        errors = [ex.error]
    elif isinstance(ex, BridgeErrorsException):
        errors = ex.errors
    else:
...
def execute_sql_statement(  # pylint: disable=too-many-arguments,too-many-statements
    ...
    return BridgeResultSet(data, cursor_description, db_engine_spec)
