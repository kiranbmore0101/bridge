...
from bridge.explore.permalink.exceptions import ExplorePermalinkInvalidStateError
from bridge.explore.permalink.schemas import ExplorePermalinkPostSchema
...
class ExplorePermalinkRestApi(BaseApi):
    ...
    def post(self) -> Response:
        ...
        try:
            ...
            url = f"{http_origin}/bridge/explore/p/{key}/"
