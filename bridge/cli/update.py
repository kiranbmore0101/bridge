...
import bridge.utils.database as database_utils
from bridge.utils.encrypt import SecretsMigrator
...
def sync_tags() -> None:
    ...
    from bridge.common.tags import add_favorites, add_owners, add_types
...
def update_api_docs() -> None:
    ...
    bridge_dir = os.path.abspath(os.path.dirname(__file__))
    openapi_json = os.path.join(
        bridge_dir, "..", "..", "docs", "static", "resources", "openapi.json"
    )
    api_version = "v1"
