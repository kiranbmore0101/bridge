...
from bridge.exceptions import InvalidPayloadFormatError
from bridge.extensions import db, event_logger, security_manager
from bridge.models.core import FavStar
from bridge.models.dashboard import Dashboard
from bridge.models.slice import Slice
from bridge.schemas import error_payload_content
from bridge.sql_lab import Query as SqllabQuery
from bridge.stats_logger import BaseStatsLogger
from bridge.bridge_typing import FlaskResponse
from bridge.utils.core import get_user_id, time_function
from bridge.views.base import handle_api_exception
...
def requires_json(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: "BaseBridgeModelRestApi", *args: Any, **kwargs: Any) -> Response:
...
class BaseBridgeModelRestApi(ModelRestApi):
    """
    Extends FAB's ModelResApi to implement specific bridge generic functionality
    """
