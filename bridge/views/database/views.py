...
from bridge.constants import MODEL_VIEW_RW_METHOD_PERMISSION_MAP, RouteMethod
from bridge.exceptions import CertificateException
...
from bridge.views.base import DeleteMixin, BridgeModelView, YamlExportMixin
...
class DatabaseView(
    DatabaseMixin, BridgeModelView, DeleteMixin, YamlExportMixin
    ...
    add_template = "bridge/models/database/add.html"
    edit_template = "bridge/models/database/edit.html"
    validators_columns = {
...
class CsvToDatabaseView(CustomFormView):
    ...
    form_template = "bridge/form_view/csv_to_database_view/edit.html"
    ...
    def form_post(self, form: CsvToDatabaseForm) -> Response:
        ...
        if not schema_allows_file_upload(database, csv_table.schema):
            message = __(
                ...
                "is not allowed for csv uploads. Please contact your Bridge Admin.",
...
class ExcelToDatabaseView(SimpleFormView):
    ...
    form_template = "bridge/form_view/excel_to_database_view/edit.html"
    ...
    def form_post(self, form: ExcelToDatabaseForm) -> Response:
        ...
        if not schema_allows_file_upload(database, excel_table.schema):
            message = __(
                'Database "%(database_name)s" schema "%(schema_name)s" '
                "is not allowed for excel uploads. Please contact your Bridge Admin.",
                database_name=database.database_name,
...
class ColumnarToDatabaseView(SimpleFormView):
    ...
    form_template = "bridge/form_view/columnar_to_database_view/edit.html"
