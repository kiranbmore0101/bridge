...
from bridge import app, dataframe, db, result_set, viz
...
from bridge.extensions import cache_manager, feature_flag_manager, security_manager
...
from bridge.bridge_typing import FormData
...
def get_datasource_info(
    ...
    :raises BridgeException: If the datasource no longer exists
    """
...
# /bridge-frontend/src/dashboard/util/componentTypes.js
...
def check_explore_cache_perms(_self: Any, cache_key: str) -> None:
    ...
    :param _self: the Bridge view instance
    ...
    **kwargs: Any
    ...
    try:
        ...
        raise BridgeSecurityException(
            BridgeError(
                error_type=BridgeErrorType.FAILED_FETCHING_DATASOURCE_INFO_ERROR,
    ...
    if datasource_type is None:
        raise BridgeSecurityException(
            BridgeError(
                error_type=BridgeErrorType.UNKNOWN_DATASOURCE_TYPE_ERROR,
                level=ErrorLevel.ERROR,
...
def _deserialize_results_payload(
    ...
    if use_msgpack:
        ...
        df = result_set.BridgeResultSet.convert_table_to_df(pa_table)
