...
from bridge.dao.exceptions import DAOCreateFailedError
...
if TYPE_CHECKING:
    ...
    from bridge.sqllab.sql_json_executer import SqlJsonExecutor
...
class ExecuteSqlCommand(BaseCommand):
    ...
    def run(  # pylint: disable=too-many-statements,useless-suppression
        ...
        except (BridgeErrorException, BridgeErrorsException) as ex:
            # to make sure we raising the original
            # BridgeErrorsException || BridgeErrorsException
            raise ex
