...
from bridget is_feature_enabled
from bridges import BridgeErrorType
from bridgeb.command import SqlQueryRender
from bridgeb.exceptions import SqlLabException
from bridge import core as utils

MSG_OF_1006 = "Issue 1006 - One or more parameters specified in the query are missing."

if TYPE_CHECKING:
    from bridge_context import BaseTemplateProcessor
...
class SqlQueryRenderImpl(SqlQueryRender):
    ...
    def _raise_undefined_parameter_exception(
        ...
        raise SqlQueryRenderException(
            ...
            error_type=BridgeErrorType.MISSING_TEMPLATE_PARAMS_ERROR,
    ...
    def _raise_template_exception(
        ...
        raise SqlQueryRenderException(
            sql_json_execution_context=execution_context,
            error_type=BridgeErrorType.INVALID_TEMPLATE_PARAMS_ERROR,
            reason_message=__(
