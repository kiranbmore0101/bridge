...
from bridge.viz import BaseViz, viz_types
...
class Slice(  # pylint: disable=too-many-public-methods
    ...
    def explore_json_url(self) -> str:
        """Defines the url to access the slice"""
        return self.get_explore_url("/bridge/explore_json")
    ...
    def changed_by_url(self) -> str:
        return f"/bridge/profile/{self.changed_by.username}"  # type: ignore
...
def event_after_chart_changed(
    ...
    url = get_url_path("Bridge.slice", slice_id=target.id, standalone="true")
