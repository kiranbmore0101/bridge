...
from bridge.models.helpers import AuditMixinNullable, ImportExportMixin
...
from bridge.utils.decorators import debounce
...
class Dashboard(Model, AuditMixinNullable, ImportExportMixin):
    ...
    @property
    def url(self) -> str:
        return f"/bridge/dashboard/{self.slug or self.id}/"
    ...
    def update_thumbnail(self) -> None:
        url = get_url_path("Bridge.dashboard", dashboard_id_or_slug=self.id)
