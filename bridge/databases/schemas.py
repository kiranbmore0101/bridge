...
from bridge.exceptions import CertificateException, BridgeSecurityException
from bridge.models.core import ConfigurationMethod, Database
from bridge.security.analytics_db_safety import check_sqlalchemy_uri
from bridge.utils.core import markdown, parse_ssl_cert
...
def rename_encrypted_extra(
    ...
    **kwargs: Any,
    ...
    Bridge backwards compatible with older clients.
    """
