...
from bridge.css_templates.commands.bulk_delete import BulkDeleteCssTemplateCommand
from bridge.css_templates.commands.exceptions import (
    CssTemplateBulkDeleteFailedError,
    CssTemplateNotFoundError,
)
from bridge.css_templates.filters import CssTemplateAllTextFilter
from bridge.css_templates.schemas import (
    get_delete_ids_schema,
    openapi_spec_methods_override,
)
from bridge.extensions import event_logger
from bridge.models.core import CssTemplate
from bridge.views.base_api import BaseBridgeModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class CssTemplateRestApi(BaseBridgeModelRestApi):
