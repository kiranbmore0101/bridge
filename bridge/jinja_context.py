...
class ExtraCache:
    ...
    def url_param(
        ...
        `?foo=bar`, as in `{domain}/bridge/sqllab?foo=bar`. Then if your query is
        ...
        from bridge.views.utils import get_form_data
    ...
    def get_filters(self, column: str, remove_filter: bool = False) -> List[Filter]:
        ...
        """
        # pylint: disable=import-outside-toplevel
        from bridge.utils.core import FilterOperator
        from bridge.views.utils import get_form_data
