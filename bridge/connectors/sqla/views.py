...
from bridge.connectors.base.views import DatasourceModelView
...
class RowLevelSecurityListWidget(
    ...
    template = "bridge/models/rls/list.html"
...
class RowLevelSecurityFiltersModelView(  # pylint: disable=too-many-ancestors
    BridgeModelView, DeleteMixin
):
    datamodel = SQLAInterface(models.RowLevelSecurityFilter)

    list_widget = cast(BridgeListWidget, RowLevelSecurityListWidget)
...
class TableModelView(  # pylint: disable=too-many-ancestors
    ...
    description_columns = {
        ...
        "sql": _(
            "This fields acts a Bridge view, meaning that Bridge will "
