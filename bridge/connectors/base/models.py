...
from bridge.models.helpers import AuditMixinNullable, ImportExportMixin, QueryResult
from bridge.models.slice import Slice
from bridge.bridge_typing import FilterValue, FilterValues, QueryObjectDict
from bridge.utils import core as utils
from bridge.utils.core import GenericDataType, MediumText
...
class BaseDatasource(
    ...
    def query(self, query_obj: QueryObjectDict) -> QueryResult:
        ...
        query_obj is a dictionary representing Bridge's query interface.
        Should return a ``bridge.models.helpers.QueryResult``
        """
        raise NotImplementedError()
