...
from bridge.utils.core import generic_find_constraint_name
...
def upgrade():
    # cleanup after: https://github.com/airbnb/bridge/pull/1078
    try:
    ...
    # fixed issue: https://github.com/airbnb/bridge/issues/466
    try:
