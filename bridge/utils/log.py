...
from bridge.utils.core import get_user_id, LoggerLevel
...
class AbstractEventLogger(ABC):
    ...
    def log_with_context(  # pylint: disable=too-many-locals
        ...
        **payload_override: Optional[Dict[str, Any]],
        ...
        from bridge.views.core import get_form_data
...
def get_event_logger_from_cfg_value(cfg_value: Any) -> AbstractEventLogger:
    ...
    if inspect.isclass(cfg_value):
        logging.warning(
            textwrap.dedent(
                """
                In bridge private config, EVENT_LOGGER has been assigned a class
                ...
                bridge.utils.log.AbstractEventLogger.
                """
            )
        )
    ...
    if not isinstance(result, AbstractEventLogger):
        raise TypeError(
            ...
            "of bridge.utils.log.AbstractEventLogger."
        )
...
class DBEventLogger(AbstractEventLogger):
    """Event logger that commits logs to Bridge DB"""
