...
from bridge import app, is_feature_enabled, thumbnail_cache
from bridge.charts.commands.bulk_delete import BulkDeleteChartCommand
from bridge.charts.commands.create import CreateChartCommand
from bridge.charts.commands.delete import DeleteChartCommand
...
from bridge.charts.commands.export import ExportChartsCommand
from bridge.charts.commands.importers.dispatcher import ImportChartsCommand
from bridge.charts.commands.update import UpdateChartCommand
from bridge.charts.dao import ChartDAO
from bridge.charts.filters import (
    ChartAllTextFilter,
...
from bridge.charts.schemas import (
    CHART_SCHEMAS,
    ChartPostSchema,
    ChartPutSchema,
...
from bridge.tasks.thumbnails import cache_chart_thumbnail
from bridge.utils.screenshots import ChartScreenshot
...
class ChartRestApi(BaseBridgeModelRestApi):
    ...
    def cache_screenshot(self, pk: int, **kwargs: Any) -> WerkzeugResponse:
        ...
        chart_url = get_url_path("Bridge.slice", slice_id=chart.id, standalone="true")
    ...
    def thumbnail(self, pk: int, digest: str, **kwargs: Any) -> WerkzeugResponse:
        ...
        url = get_url_path("Bridge.slice", slice_id=chart.id, standalone="true")
