...
from bridge.constants import PASSWORD_MASK
from bridge.databases.schemas import encrypted_field_properties, EncryptedString
from bridge.databases.utils import make_url_safe
from bridge.db_engine_specs.base import BaseEngineSpec, BasicPropertiesType
from bridge.db_engine_specs.exceptions import BridgeDBAPIConnectionError
from bridge.errors import BridgeError, BridgeErrorType
...
if TYPE_CHECKING:
    from bridge.models.core import Database  # pragma: no cover
...
class BigQueryEngineSpec(BaseEngineSpec):
    ...
    custom_errors: Dict[Pattern[str], Tuple[str, BridgeErrorType, Dict[str, Any]]] = {
        CONNECTION_DATABASE_PERMISSIONS_REGEX: (
            ...
            BridgeErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR,
            {},
        ),
    ...
    def get_dbapi_exception_mapping(cls) -> Dict[Type[Exception], Type[Exception]]:
        ...
        return {DefaultCredentialsError: BridgeDBAPIConnectionError}
