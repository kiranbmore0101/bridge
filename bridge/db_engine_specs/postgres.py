...
from bridge.db_engine_specs.base import (
    BaseEngineSpec,
...
class PostgresBaseEngineSpec(BaseEngineSpec):
    ...
    custom_errors: Dict[Pattern[str], Tuple[str, BridgeErrorType, Dict[str, Any]]] = {
        CONNECTION_INVALID_USERNAME_REGEX: (
            ...
            BridgeErrorType.CONNECTION_INVALID_USERNAME_ERROR,
            {"invalid": ["username"]},
        ),
        CONNECTION_INVALID_PASSWORD_REGEX: (
            __('The password provided for username "%(username)s" is incorrect.'),
            BridgeErrorType.CONNECTION_INVALID_PASSWORD_ERROR,
...
class PostgresEngineSpec(PostgresBaseEngineSpec, BasicParametersMixin):
    ...
    def get_extra_params(database: "Database") -> Dict[str, Any]:
        ...
        :raises BridgeException: If database extra json payload is unparseable
        """
        try:
            extra = json.loads(database.extra or "{}")
        except json.JSONDecodeError as ex:
            raise BridgeException("Unable to parse database extras") from ex
