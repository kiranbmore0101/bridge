...
from bridge.db_engine_specs.base import BaseEngineSpec, LimitMethod
from bridge.db_engine_specs.exceptions import (
    BridgeDBAPIDatabaseError,
    BridgeDBAPIOperationalError,
    BridgeDBAPIProgrammingError,
)
...
class KustoSqlEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> Dict[Type[Exception], Type[Exception]]:
        ...
        return {
            kusto_exceptions.DatabaseError: BridgeDBAPIDatabaseError,
            kusto_exceptions.OperationalError: BridgeDBAPIOperationalError,
            kusto_exceptions.ProgrammingError: BridgeDBAPIProgrammingError,
        }
