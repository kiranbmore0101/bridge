...
class ElasticSearchEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> Dict[Type[Exception], Type[Exception]]:
        ...
        return {
            es_exceptions.DatabaseError: BridgeDBAPIDatabaseError,
            es_exceptions.OperationalError: BridgeDBAPIOperationalError,
            es_exceptions.ProgrammingError: BridgeDBAPIProgrammingError,
        }
