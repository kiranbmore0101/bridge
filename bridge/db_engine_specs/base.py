...
from bridge import security_manager, sql_parse
from bridge.databases.utils import make_url_safe
from bridge.errors import ErrorLevel, BridgeError, BridgeErrorType
from bridge.sql_parse import ParsedQuery, Table
from bridge.bridge_typing import ResultSetColumnType
from bridge.utils import core as utils
from bridge.utils.core import ColumnSpec, GenericDataType, get_username
from bridge.utils.hashing import md5_sha_from_str
from bridge.utils.network import is_hostname_valid, is_port_open

if TYPE_CHECKING:
    # prevent circular imports
    from bridge.connectors.sqla.models import TableColumn
...
class BaseEngineSpec:  # pylint: disable=too-many-public-methods
    ...
    custom_errors: Dict[
        Pattern[str], Tuple[str, BridgeErrorType, Dict[str, Any]]
    ] = {}
    ...
    def get_dbapi_mapped_exception(cls, exception: Exception) -> Exception:
        """
        Get a bridge custom DBAPI exception from the driver specific exception.
        ...
        :return: Bridge custom DBAPI exception
        """
    ...
    def extract_errors(
        ...
        return [
            BridgeError(
                error_type=BridgeErrorType.GENERIC_DB_ENGINE_ERROR,
        ...
        try:
            ...
            errors.append(
                BridgeError(
                    ...
                    error_type=BridgeErrorType.CONNECTION_INVALID_PORT_ERROR,
                    level=ErrorLevel.ERROR,
                    extra={"invalid": ["port"]},
                ),
            )
        if not (isinstance(port, int) and 0 <= port < 2**16):
            ...
            errors.append(
                BridgeError(
                    ...
                    error_type=BridgeErrorType.CONNECTION_PORT_CLOSED_ERROR,
                    level=ErrorLevel.ERROR,
                    extra={"invalid": ["port"]},
                ),
            )
