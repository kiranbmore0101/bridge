...
from bridge.commands.export.assets import ExportAssetsCommand
from bridge.commands.importers.exceptions import (
    IncorrectFormatError,
    NoValidFilesFoundError,
)
from bridge.commands.importers.v1.assets import ImportAssetsCommand
from bridge.commands.importers.v1.utils import get_contents_from_bundle
from bridge.extensions import event_logger
from bridge.views.base_api import requires_form_data
...
class ImportExportRestApi(BaseApi):
    ...
    def export(self) -> Response:
        ...
        get:
          description: >-
            Returns a ZIP file with all the Bridge assets (databases, datasets, charts,
