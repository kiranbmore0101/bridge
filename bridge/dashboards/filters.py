...
from bridge.security.guest_token import GuestTokenResourceType, GuestUser
from bridge.utils.core import get_user_id
from bridge.views.base import BaseFilter
from bridge.views.base_api import BaseFavoriteFilter
...
class DashboardAccessFilter(BaseFilter):  # pylint: disable=too-few-public-methods
    ...
    def apply(self, query: Query, value: Any) -> Query:
        ...
        if is_feature_enabled("EMBEDDED_BRIDGE") and security_manager.is_guest_user(
            g.user
        ):
