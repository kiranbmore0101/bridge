...
from bridge.commands.exceptions import ObjectNotFoundError
from bridge.dashboards.commands.exceptions import DashboardNotFoundError
from bridge.dashboards.dao import DashboardDAO
from bridge.dashboards.filter_sets.commands.create import CreateFilterSetCommand
from bridge.dashboards.filter_sets.commands.delete import DeleteFilterSetCommand
from bridge.dashboards.filter_sets.commands.exceptions import (
...
from bridge.dashboards.filter_sets.commands.update import UpdateFilterSetCommand
from bridge.dashboards.filter_sets.consts import (
    DASHBOARD_FIELD,
    DASHBOARD_ID_FIELD,
    DESCRIPTION_FIELD,
...
from bridge.dashboards.filter_sets.filters import FilterSetFilter
from bridge.dashboards.filter_sets.schemas import (
    FilterSetPostSchema,
    FilterSetPutSchema,
)
from bridge.extensions import event_logger
from bridge.models.filter_set import FilterSet
...
class FilterSetRestApi(BaseBridgeModelRestApi):
    ...
    def _init_properties(self) -> None:
        ...
        super(BaseBridgeModelRestApi, self)._init_properties()
