...
If you decide to join the [Community Slack](https://join.slack.com/t/apache-bridge/shared_invite/zt-1jp6hjzrq-H0PlFtToyLWuPiJDuRWCNw), please adhere to the following rules:
...
- Please follow the guidelines as outlined in the Bridge Community [code of conduct here](https://github.com/kiranbmore0101/bridge/blob/master/CODE_OF_CONDUCT.md).
