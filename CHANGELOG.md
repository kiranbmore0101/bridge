...
- [#20442](https://github.com/kiranbmore0101/bridge/pull/20442) fix(db): Show the only db install guide when the db is already installed and error is existed while importing file. (@prosdev0107)
...
- [#19324](https://github.com/kiranbmore0101/bridge/pull/19324) feat: introduce hashids permalink keys (@villebro)
...
- [#18876](https://github.com/kiranbmore0101/bridge/pull/18876) feat(native-filters): Don't scroll main window when scrolling filter bar (@kgabryje)
...
- [#18161](https://github.com/kiranbmore0101/bridge/pull/18161) feat(helm): Add schema of values in Helm Chart (@ad-m)
...
- [#17372](https://github.com/kiranbmore0101/bridge/pull/17372) feat: Add single select and inverse selection to numeric range (#16722) (@mhoustonataegis)
...
- [#19370](https://github.com/kiranbmore0101/bridge/pull/19370) fix(sql lab): replace the output column in the query history table (@diegomedina248)
...
- [#19355](https://github.com/kiranbmore0101/bridge/pull/19355) fix: Fix NoAuthorizationError in /me endpoint (@geido)
...
- [#19341](https://github.com/kiranbmore0101/bridge/pull/19341) fix: Null values on Explore filter (@michael-s-molina)
- [#19338](https://github.com/kiranbmore0101/bridge/pull/19338) fix(docs): spelling (@ndbu)
- [#19339](https://github.com/kiranbmore0101/bridge/pull/19339) fix(embedded): download chart as image (@lilykuang)
- [#19327](https://github.com/kiranbmore0101/bridge/pull/19327) fix(dashboard): Chart stuck in loading state when when datasets request and chart request fail (@kgabryje)
- [#19316](https://github.com/kiranbmore0101/bridge/pull/19316) fix(explore): make to convert null to N/A in view results (@prosdev0107)
- [#19326](https://github.com/kiranbmore0101/bridge/pull/19326) fix: regression on Select component when handling null values (@diegomedina248)
- [#18741](https://github.com/kiranbmore0101/bridge/pull/18741) fix(dashboard): fix default filter bar visibility + add docs (@villebro)
- [#19305](https://github.com/kiranbmore0101/bridge/pull/19305) fix(cache): only warn about fallback cache for non-debug mode (@villebro)
- [#19283](https://github.com/kiranbmore0101/bridge/pull/19283) fix: Don't allow duplicated tag values in the Select (@michael-s-molina)
- [#19296](https://github.com/kiranbmore0101/bridge/pull/19296) fix: default toast position (@suddjian)
- [#19258](https://github.com/kiranbmore0101/bridge/pull/19258) fix(sql lab): most recently selected table should appear at the top of the list on the left panel (@diegomedina248)
- [#19223](https://github.com/kiranbmore0101/bridge/pull/19223) fix(dashboard): make to show the correct owned objects (@prosdev0107)
- [#19263](https://github.com/kiranbmore0101/bridge/pull/19263) fix(presto/trino): Add TIME/TIMESTAMP WITH TIME ZONE (@john-bodley)
- [#19269](https://github.com/kiranbmore0101/bridge/pull/19269) fix: write new dataset on update table if it doesn't exist (@eschutho)
- [#19069](https://github.com/kiranbmore0101/bridge/pull/19069) fix: custom SQL in Sort By Breaks Bar Chart (@diegomedina248)
- [#19140](https://github.com/kiranbmore0101/bridge/pull/19140) fix(chart-crud): make to update Viz type Filter label to Chart type (@prosdev0107)
- [#19242](https://github.com/kiranbmore0101/bridge/pull/19242) fix: allow subquery in ad-hoc SQL (@lilykuang)
- [#18926](https://github.com/kiranbmore0101/bridge/pull/18926) fix(explore comma): make that the comma can be added by removing it from token separators… (@prosdev0107)
- [#19234](https://github.com/kiranbmore0101/bridge/pull/19234) fix: adhoc column in legacy chart (@zhaoyongjie)
- [#19076](https://github.com/kiranbmore0101/bridge/pull/19076) fix: allow to select <NULL> in a native filter single mode (@diegomedina248)
- [#19159](https://github.com/kiranbmore0101/bridge/pull/19159) fix(select): make to consider the case sensitive in case of d3 format selector (@prosdev0107)
- [#19139](https://github.com/kiranbmore0101/bridge/pull/19139) fix: Popovers in Explore not attached to the fields they are triggered by (@diegomedina248)
- [#19152](https://github.com/kiranbmore0101/bridge/pull/19152) fix: auto-complete of tables and names are not working in SQL lab (@diegomedina248)
- [#19226](https://github.com/kiranbmore0101/bridge/pull/19226) fix: Revert "refactor: converted QueryAutoRefresh to functional component … (@hughhhh)
- [#19158](https://github.com/kiranbmore0101/bridge/pull/19158) fix: Logic for showing extension in Global Nav (@hughhhh)
- [#19111](https://github.com/kiranbmore0101/bridge/pull/19111) fix(sqllab): Updated blank states for query results and query history (@lyndsiWilliams)
- [#19143](https://github.com/kiranbmore0101/bridge/pull/19143) fix: clean up chart metadata config (@suddjian)
- [#19084](https://github.com/kiranbmore0101/bridge/pull/19084) fix(dashboard-css): make to stay custom css when reload (@prosdev0107)
- [#19125](https://github.com/kiranbmore0101/bridge/pull/19125) fix(dbs-dropdown): make to allow the search in supported db dropdown (@prosdev0107)
- [#19121](https://github.com/kiranbmore0101/bridge/pull/19121) fix(dashboard): scrolling table viz overlaps next chart (@diegomedina248)
- [#19023](https://github.com/kiranbmore0101/bridge/pull/19023) fix: Add perm for showing DBC-UI in Global Nav (@hughhhh)
- [#19080](https://github.com/kiranbmore0101/bridge/pull/19080) fix(dashboard-edge-cutting): make to be not cut without Filter (@prosdev0107)
- [#19110](https://github.com/kiranbmore0101/bridge/pull/19110) fix: cache key with guest token rls (@lilykuang)
- [#19095](https://github.com/kiranbmore0101/bridge/pull/19095) fix(dashboard): Empty states overflowing small chart containers (@kgabryje)
- [#18947](https://github.com/kiranbmore0101/bridge/pull/18947) fix(plugin-chart-echarts): make to allow the custome of x & y axis title margin i… (@prosdev0107)
- [#19088](https://github.com/kiranbmore0101/bridge/pull/19088) fix(dashboard): import handle missing excluded charts (@villebro)
- [#19072](https://github.com/kiranbmore0101/bridge/pull/19072) fix: Show Totals error with sort and group by together (@codemaster08240328)
- [#19037](https://github.com/kiranbmore0101/bridge/pull/19037) fix: Database import error with a new field (@codemaster08240328)
- [#19047](https://github.com/kiranbmore0101/bridge/pull/19047) fix: SQL Lab autocomplete for selected tables (@hughhhh)
- [#19071](https://github.com/kiranbmore0101/bridge/pull/19071) fix: Pivot Table Conditional Formatting Doesn't Show All Options (@diegomedina248)
- [#19030](https://github.com/kiranbmore0101/bridge/pull/19030) fix(allow-db-explore): make that the set the allow-db-explore option (@prosdev0107)
- [#18822](https://github.com/kiranbmore0101/bridge/pull/18822) fix(altered-modal): make specified text fields wrap in table (@prosdev0107)
- [#19061](https://github.com/kiranbmore0101/bridge/pull/19061) fix: enable find text browser functionality inside SQL Lab editor (@diegomedina248)
- [#19054](https://github.com/kiranbmore0101/bridge/pull/19054) fix: show the total row count in the SQL Lab Query History tab when limited by DISPLAY_MAX_ROW (@diegomedina248)
- [#19070](https://github.com/kiranbmore0101/bridge/pull/19070) fix: Select clear and loading icons overlap (@michael-s-molina)
- [#19065](https://github.com/kiranbmore0101/bridge/pull/19065) fix: Dataset search when creating a chart (@michael-s-molina)
- [#19024](https://github.com/kiranbmore0101/bridge/pull/19024) fix(time-series table): display null values in time-series table and sortable (@graceguo-supercat)
- [#19018](https://github.com/kiranbmore0101/bridge/pull/19018) fix: ensure validation for db modal for googlesheets (@pkdotson)
- [#19052](https://github.com/kiranbmore0101/bridge/pull/19052) fix: add previous line hotkey to SQL Lab for macOS (@diegomedina248)
- [#18690](https://github.com/kiranbmore0101/bridge/pull/18690) fix: Update time grain expressions for Spark >= 3.x (@thomasdesr)
- [#19048](https://github.com/kiranbmore0101/bridge/pull/19048) fix: remove unnecessary divider (@pkdotson)
- [#19059](https://github.com/kiranbmore0101/bridge/pull/19059) fix(deck.gl): make Deck.gl Javascript tooltip generator works correctly (@chanyou0311)
- [#19044](https://github.com/kiranbmore0101/bridge/pull/19044) fix: improve cypress flakiness (@etr2460)
- [#19043](https://github.com/kiranbmore0101/bridge/pull/19043) fix(big-number): Big Number with Trendline Chart is not working if Time Grain is set to Month (@stephenLYZ)
- [#19040](https://github.com/kiranbmore0101/bridge/pull/19040) fix(docs): update impala.mdx with correct product name (@DLT1412)
- [#18951](https://github.com/kiranbmore0101/bridge/pull/18951) fix(SQL Editor): names new query tabs correctly (@cccs-Dustin)
- [#18877](https://github.com/kiranbmore0101/bridge/pull/18877) fix(nested-tab-available): make the another tabs into one tabs available (@prosdev0107)
- [#18960](https://github.com/kiranbmore0101/bridge/pull/18960) fix(chart): deprecate persisting url_params (@villebro)
- [#18973](https://github.com/kiranbmore0101/bridge/pull/18973) fix(packages): Fixing users packages (@craig-rueda)
- [#18892](https://github.com/kiranbmore0101/bridge/pull/18892) fix(tooltip-not-dissapeared): make the tooltip disappear when mouse away (@prosdev0107)
- [#18982](https://github.com/kiranbmore0101/bridge/pull/18982) fix(external-link): change the external link in creating chart dashboard (@prosdev0107)
- [#18963](https://github.com/kiranbmore0101/bridge/pull/18963) fix(native-filters): Default value not shown in native filters (@kgabryje)
- [#18958](https://github.com/kiranbmore0101/bridge/pull/18958) fix(plugin-chart-echarts): fix customize margin (@stephenLYZ)
- [#18971](https://github.com/kiranbmore0101/bridge/pull/18971) fix: add/find owners from report/alert modal (@graceguo-supercat)
- [#18835](https://github.com/kiranbmore0101/bridge/pull/18835) fix(Explore): Pivot table V2 sort by failure with D&D enabled (@geido)
- [#18817](https://github.com/kiranbmore0101/bridge/pull/18817) fix(sql Lab tabs): Empty SQL Lab tabs (@AAfghahi)
- [#18758](https://github.com/kiranbmore0101/bridge/pull/18758) fix: CSV upload with overprescribed table/schema (@john-bodley)
- [#18849](https://github.com/kiranbmore0101/bridge/pull/18849) fix: Null schema issue in the list of saved queries. (@codemaster08240328)
- [#18939](https://github.com/kiranbmore0101/bridge/pull/18939) fix(deck.gl): multiple layers map size is shrunk (@stephenLYZ)
- [#18695](https://github.com/kiranbmore0101/bridge/pull/18695) fix(native-filter): fix required filters of a dashboard won't load properly (@stephenLYZ)
- [#18796](https://github.com/kiranbmore0101/bridge/pull/18796) fix: Monospacing errors in dashboards & charts (@codemaster08240328)
- [#18855](https://github.com/kiranbmore0101/bridge/pull/18855) fix: Metadata browser in SQL not render nicely in Safari (@codemaster08240328)
- [#18934](https://github.com/kiranbmore0101/bridge/pull/18934) fix(sqllab): Un-render deselected tabs (@etr2460)
- [#18853](https://github.com/kiranbmore0101/bridge/pull/18853) fix: filter indicator pointing issue on popover (@codemaster08240328)
- [#18911](https://github.com/kiranbmore0101/bridge/pull/18911) fix: Set force=true for exporting CSV on dashboard charts (@hughhhh)
- [#18920](https://github.com/kiranbmore0101/bridge/pull/18920) fix(docs): add missing static files to build (@villebro)
- [#18894](https://github.com/kiranbmore0101/bridge/pull/18894) fix: Source from Apache Foundation's website link (@paulocauca)
- [#18852](https://github.com/kiranbmore0101/bridge/pull/18852) fix(dashboard): incorrect chart error with slow dataset api request (@ktmud)
- [#18886](https://github.com/kiranbmore0101/bridge/pull/18886) fix: Database list in Docusaurus (@geido)
- [#18857](https://github.com/kiranbmore0101/bridge/pull/18857) fix: FilterBox date endpoints to use [inclusive, exclusive) (@etr2460)
- [#18846](https://github.com/kiranbmore0101/bridge/pull/18846) fix(key-value): lost url_params after long-url feature (@zhaoyongjie)
- [#18739](https://github.com/kiranbmore0101/bridge/pull/18739) fix: Position of arrows in Table chart (@geido)
- [#18789](https://github.com/kiranbmore0101/bridge/pull/18789) fix(hive): stop query on the processing engine when user clicks STOP on SQL Lab (@saurabh3091)
- [#18788](https://github.com/kiranbmore0101/bridge/pull/18788) fix(Explore): Annotation cache should be ignore when adding new / updated annotation (@geido)
- [#18746](https://github.com/kiranbmore0101/bridge/pull/18746) fix(mssql): support top syntax for limiting queries (@sujiplr)
- [#18813](https://github.com/kiranbmore0101/bridge/pull/18813) fix(altered-modal): displayed the metric value in altered modal correctly (@prosdev0107)
- [#18749](https://github.com/kiranbmore0101/bridge/pull/18749) fix(sqllab): Removed the tooltip from CopyToClipboard button in sqllab (@prosdev0107)
- [#18782](https://github.com/kiranbmore0101/bridge/pull/18782) fix: contribution operator meets nan value (@zhaoyongjie)
- [#18756](https://github.com/kiranbmore0101/bridge/pull/18756) fix: update standalone url for slack reports (@hughhhh)
- [#18786](https://github.com/kiranbmore0101/bridge/pull/18786) fix(delete-modal): Changed the color of the help text with grayScale.dark1 in DeleteModal (@prosdev0107)
- [#18717](https://github.com/kiranbmore0101/bridge/pull/18717) fix(Dashboard): Fix blinking native filters on zoom (@geido)
- [#18751](https://github.com/kiranbmore0101/bridge/pull/18751) fix(helm): bump Helm chart release version (@wiktor2200)
- [#18738](https://github.com/kiranbmore0101/bridge/pull/18738) fix(Explore): Fix cache timeout field not being saved and unit tests (@geido)
- [#18725](https://github.com/kiranbmore0101/bridge/pull/18725) fix: report list search by created_by (@graceguo-supercat)
- [#18056](https://github.com/kiranbmore0101/bridge/pull/18056) fix(CRUD/listviews): Errors with rison and search strings using special characters (@corbinrobb)
- [#18714](https://github.com/kiranbmore0101/bridge/pull/18714) fix: Only redirect to relative paths when authentication expires (@geido)
- [#15246](https://github.com/kiranbmore0101/bridge/pull/15246) fix: passing url params in sqllab (@maltoze)
- [#18666](https://github.com/kiranbmore0101/bridge/pull/18666) fix(sqllab): fix query results sorting (@corbinrobb)
- [#18686](https://github.com/kiranbmore0101/bridge/pull/18686) fix: Fixed dancing tooltip in database list action buttons (@lyndsiWilliams)
- [#18683](https://github.com/kiranbmore0101/bridge/pull/18683) fix: unambiguous trino driver (@betodealmeida)
- [#18685](https://github.com/kiranbmore0101/bridge/pull/18685) fix(build): update webpack jsx paths (@anoojkinaginlsn)
- [#18684](https://github.com/kiranbmore0101/bridge/pull/18684) fix: revert handle null values in time-series table (@graceguo-supercat)
- [#17826](https://github.com/kiranbmore0101/bridge/pull/17826) fix(deck.gl): update view state on property changes (#17720) (@hbruch)
- [#18603](https://github.com/kiranbmore0101/bridge/pull/18603) fix(Explore): Force different color for same metrics in Mixed Time-Series (@geido)
- [#18658](https://github.com/kiranbmore0101/bridge/pull/18658) fix: dataset modal doesn't work in dev mode (@stephenLYZ)
- [#18567](https://github.com/kiranbmore0101/bridge/pull/18567) fix(mssql): support cte in virtual tables (@sujiplr)
- [#18633](https://github.com/kiranbmore0101/bridge/pull/18633) fix(csv-export): pivot v2 with verbose names (@villebro)
- [#18084](https://github.com/kiranbmore0101/bridge/pull/18084) fix(histogram): display correct percentile value instead of formula (@hoangminhquan-lhsdt)
- [#18628](https://github.com/kiranbmore0101/bridge/pull/18628) fix: check embedded feature flag in request loader (@lilykuang)
- [#18562](https://github.com/kiranbmore0101/bridge/pull/18562) fix: user UUIDs on export for Native Filter Configuration (@hughhhh)
- [#18619](https://github.com/kiranbmore0101/bridge/pull/18619) fix(helm): Fix support for ingress.ingressClassName (@ad-m)
- [#18609](https://github.com/kiranbmore0101/bridge/pull/18609) fix: change database database selector (@pkdotson)
- [#18601](https://github.com/kiranbmore0101/bridge/pull/18601) fix(jest): add bridge-frontend to testRegex (@villebro)
- [#18564](https://github.com/kiranbmore0101/bridge/pull/18564) fix: sqllab schema select error msg (@pkdotson)
- [#18579](https://github.com/kiranbmore0101/bridge/pull/18579) fix(sqla): avoid unnecessary groupby in samples request (@villebro)
- [#18246](https://github.com/kiranbmore0101/bridge/pull/18246) fix(listview): add nowrap to view mode container (@villebro)
- [#18577](https://github.com/kiranbmore0101/bridge/pull/18577) fix: Update docusaurus.config.js (@hughhhh)
- [#18575](https://github.com/kiranbmore0101/bridge/pull/18575) fix: bridge-doc.yaml workflow to not be immutable on deploy (@hughhhh)
- [#18182](https://github.com/kiranbmore0101/bridge/pull/18182) fix: new alert should have force_screenshot be true (@graceguo-supercat)
- [#18252](https://github.com/kiranbmore0101/bridge/pull/18252) fix(plugin-chart-echarts): fix forecasts on verbose metrics (@villebro)
- [#18240](https://github.com/kiranbmore0101/bridge/pull/18240) fix(teradata): LIMIT syntax (@dmcnulla)
- [#18224](https://github.com/kiranbmore0101/bridge/pull/18224) fix(alert): remove extra < character in email report (@graceguo-supercat)
- [#18201](https://github.com/kiranbmore0101/bridge/pull/18201) fix: Build scripts (@geido)
- [#18219](https://github.com/kiranbmore0101/bridge/pull/18219) fix: Add mexico back to country map (@etr2460)
- [#18181](https://github.com/kiranbmore0101/bridge/pull/18181) fix: Explore long URL problem (@michael-s-molina)
- [#18217](https://github.com/kiranbmore0101/bridge/pull/18217) fix(plugin-chart-echarts): use verbose x-axis name when defined (@villebro)
- [#18216](https://github.com/kiranbmore0101/bridge/pull/18216) fix(explore): Pie chart label formatting when series is temporal (@kgabryje)
- [#17881](https://github.com/kiranbmore0101/bridge/pull/17881) fix(sql): unable to filter text with quotes (@stephenLYZ)
- [#18205](https://github.com/kiranbmore0101/bridge/pull/18205) fix(tests): Remove walrus operator for Python 3.7 compatiblity (@ad-m)
- [#18145](https://github.com/kiranbmore0101/bridge/pull/18145) fix(native-filters): values is not sorted when setting sort option (@stephenLYZ)
- [#18174](https://github.com/kiranbmore0101/bridge/pull/18174) fix(helm): allows extra top-level properties (@ad-m)
- [#18180](https://github.com/kiranbmore0101/bridge/pull/18180) fix: Default values getting cleared in native filters form (@geido)
- [#17986](https://github.com/kiranbmore0101/bridge/pull/17986) fix: Assign an owner when creating a dataset from a csv, excel or tabular (@cccs-joel)
- [#18171](https://github.com/kiranbmore0101/bridge/pull/18171) fix: null value and empty string in filter (@zhaoyongjie)
- [#18137](https://github.com/kiranbmore0101/bridge/pull/18137) fix(dashboard): support input undo when editing chart title (@stephenLYZ)
- [#18157](https://github.com/kiranbmore0101/bridge/pull/18157) fix: remove standalone (@AAfghahi)
- [#18164](https://github.com/kiranbmore0101/bridge/pull/18164) fix: Dataset column names are no longer editable (@lyndsiWilliams)
- [#18117](https://github.com/kiranbmore0101/bridge/pull/18117) fix: exclude node_modules from ts tracking (@etr2460)
- [#18146](https://github.com/kiranbmore0101/bridge/pull/18146) fix(textarea-control): ace editor input exception (@stephenLYZ)
- [#18046](https://github.com/kiranbmore0101/bridge/pull/18046) fix(import_datasources): --sync flag works correctly (@cccs-Dustin)
- [#18152](https://github.com/kiranbmore0101/bridge/pull/18152) fix: undefined error when adding extra sequential color scheme (@kgabryje)
- [#17843](https://github.com/kiranbmore0101/bridge/pull/17843) fix(explore): fix chart embed code modal glitch (@stephenLYZ)
- [#18111](https://github.com/kiranbmore0101/bridge/pull/18111) fix: logging warning on dataframe (don't use python's warnings) (@dpgaspar)
- [#18089](https://github.com/kiranbmore0101/bridge/pull/18089) fix(docs): load correctly image for "Create New Chart" (@ad-m)
- [#18097](https://github.com/kiranbmore0101/bridge/pull/18097) fix: contributing misspelling (@em0227)
- [#18086](https://github.com/kiranbmore0101/bridge/pull/18086) fix: can't use examples helpers on non app context based environment (@ofekisr)
- [#18087](https://github.com/kiranbmore0101/bridge/pull/18087) fix(docs): Correction of proper names format in README (@ad-m)
- [#18073](https://github.com/kiranbmore0101/bridge/pull/18073) fix(generator): add lockfile and fix styling issues (@villebro)
- [#18027](https://github.com/kiranbmore0101/bridge/pull/18027) fix(generator): more cleanup to plugin framework (@villebro)
- [#18051](https://github.com/kiranbmore0101/bridge/pull/18051) fix: revert "feat: stop running CI on doc updates" (@hughhhh)
- [#18039](https://github.com/kiranbmore0101/bridge/pull/18039) fix: handle null values in time-series table (@graceguo-supercat)
- [#18021](https://github.com/kiranbmore0101/bridge/pull/18021) fix: Disable filtering on wide result sets (@etr2460)
- [#18017](https://github.com/kiranbmore0101/bridge/pull/18017) fix: revert #17654 to fix subselect table name parsing (@etr2460)
- [#17995](https://github.com/kiranbmore0101/bridge/pull/17995) fix: Workaround for sqlparse issue #652 (@john-bodley)
- [#17388](https://github.com/kiranbmore0101/bridge/pull/17388) fix(sqla): Adhere to series limit ordering for pre-query (@john-bodley)
- [#17999](https://github.com/kiranbmore0101/bridge/pull/17999) fix(helm): pin correct psycopg2 version (@villebro)
- [#17988](https://github.com/kiranbmore0101/bridge/pull/17988) fix: Keep Report modal open when there's an error (@lyndsiWilliams)
- [#17985](https://github.com/kiranbmore0101/bridge/pull/17985) fix: dashboard full screen layout (@pkdotson)
- [#17931](https://github.com/kiranbmore0101/bridge/pull/17931) fix(sqllab): Dancing Tooltip in SQL editor dropdown (@lyndsiWilliams)
- [#17974](https://github.com/kiranbmore0101/bridge/pull/17974) fix: null dates in table chart (@etr2460)
- [#17878](https://github.com/kiranbmore0101/bridge/pull/17878) fix: Returns 404 instead of 500 for unknown dashboard filter state keys (@michael-s-molina)
- [#17982](https://github.com/kiranbmore0101/bridge/pull/17982) fix(native-filters): apply default value correctly when it's set (@kgabryje)
- [#17937](https://github.com/kiranbmore0101/bridge/pull/17937) fix(docs): update clickhouse.mdx (@rfraposa)
- [#17951](https://github.com/kiranbmore0101/bridge/pull/17951) fix(Select): options in the select component will be overwritten due to timing of React.setState (@stephenLYZ)
- [#17957](https://github.com/kiranbmore0101/bridge/pull/17957) fix: package.json local file dependencies (@etr2460)
- [#17786](https://github.com/kiranbmore0101/bridge/pull/17786) fix: process color scheme configs correctly (@suddjian)
- [#17918](https://github.com/kiranbmore0101/bridge/pull/17918) fix(cypress): flake cypress test case (@zhaoyongjie)
- [#17920](https://github.com/kiranbmore0101/bridge/pull/17920) fix(helm): service account apiVersion indentation (@wiktor2200)
- [#17877](https://github.com/kiranbmore0101/bridge/pull/17877) fix(translation): include babel-compile in Dockerfile (#17876) (@hbruch)
- [#17872](https://github.com/kiranbmore0101/bridge/pull/17872) fix(explore): simple tab content input problem in the filter control (@stephenLYZ)
- [#17887](https://github.com/kiranbmore0101/bridge/pull/17887) fix: Removes duplicated import in dashboard filter state tests (@michael-s-molina)
- [#17885](https://github.com/kiranbmore0101/bridge/pull/17885) fix: tests can failed on different order executions (@ofekisr)
- [#17886](https://github.com/kiranbmore0101/bridge/pull/17886) fix: failed mypy in master branch (@ofekisr)
- [#17854](https://github.com/kiranbmore0101/bridge/pull/17854) fix(ui): show SCHEDULED_QUERIES template in SqlLab (@cemremengu)
- [#17851](https://github.com/kiranbmore0101/bridge/pull/17851) fix(deckgl): deckgl unable to load map (@zhaoyongjie)
- [#17856](https://github.com/kiranbmore0101/bridge/pull/17856) fix: corrected misspelling in percent_metrics (@briannguyen4)
- [#17784](https://github.com/kiranbmore0101/bridge/pull/17784) fix: extra column in metrics (@betodealmeida)
- [#17740](https://github.com/kiranbmore0101/bridge/pull/17740) fix: dataset extra import/export (@betodealmeida)
- [#17680](https://github.com/kiranbmore0101/bridge/pull/17680) fix: replace datamask with key from new key value api (@pkdotson)
- [#17726](https://github.com/kiranbmore0101/bridge/pull/17726) fix(explore): make SORT DESCENDING visible if SORT BY has value (@stephenLYZ)
- [#17823](https://github.com/kiranbmore0101/bridge/pull/17823) fix: import typeddict from extensions (@villebro)
- [#17813](https://github.com/kiranbmore0101/bridge/pull/17813) fix: map schemes json to SequentialScheme (#17812) (@hbruch)
- [#17788](https://github.com/kiranbmore0101/bridge/pull/17788) fix: accept null params for validation (@eschutho)
- [#17800](https://github.com/kiranbmore0101/bridge/pull/17800) fix(docs): bump broken packages (@villebro)
- [#17751](https://github.com/kiranbmore0101/bridge/pull/17751) fix: [alert] allow decimal for alert threshold value (@graceguo-supercat)
- [#17783](https://github.com/kiranbmore0101/bridge/pull/17783) fix: New Members per Month time range (@betodealmeida)
- [#17775](https://github.com/kiranbmore0101/bridge/pull/17775) fix: running dev-server on a different port (@betodealmeida)
- [#17499](https://github.com/kiranbmore0101/bridge/pull/17499) fix: [alert] should run alert query from report account (@graceguo-supercat)
- [#17777](https://github.com/kiranbmore0101/bridge/pull/17777) fix(filter-sets): 404 on dashboard load (@villebro)
- [#17774](https://github.com/kiranbmore0101/bridge/pull/17774) fix(alembic): Making Alembic logger config optional (@craig-rueda)
- [#17768](https://github.com/kiranbmore0101/bridge/pull/17768) fix: change 401 response to a 403 for Security Exceptions (@rusackas)
- [#17760](https://github.com/kiranbmore0101/bridge/pull/17760) fix: miss-spelling on CONTRIBUTING.md line 1351 (@MayUWish)
- [#17765](https://github.com/kiranbmore0101/bridge/pull/17765) fix(plugin-chart-table): sort alphanumeric columns case insensitive (@kgabryje)
- [#17730](https://github.com/kiranbmore0101/bridge/pull/17730) fix: add **init**.py to key_value (@bkyryliuk)
- [#17727](https://github.com/kiranbmore0101/bridge/pull/17727) fix: local warning in the frontend development (@stephenLYZ)
- [#17738](https://github.com/kiranbmore0101/bridge/pull/17738) fix: column extra in import/export (@betodealmeida)
- [#17748](https://github.com/kiranbmore0101/bridge/pull/17748) fix: import DB errors (@betodealmeida)
- [#17741](https://github.com/kiranbmore0101/bridge/pull/17741) fix: import dashboard stale filter_scopes (@betodealmeida)
- [#17649](https://github.com/kiranbmore0101/bridge/pull/17649) fix(Mixed Timeseries Chart): Custom Metric Label (@Yahyakiani)
- [#17732](https://github.com/kiranbmore0101/bridge/pull/17732) fix: import dash with missing immune ID (@betodealmeida)
- [#17713](https://github.com/kiranbmore0101/bridge/pull/17713) fix(postgres): remove redundant tz factory (@villebro)
- [#17711](https://github.com/kiranbmore0101/bridge/pull/17711) fix(explore): don't apply time range filter to Samples table (@kgabryje)
- [#17690](https://github.com/kiranbmore0101/bridge/pull/17690) fix: Dashboard header negative margin on save (@geido)
- [#17703](https://github.com/kiranbmore0101/bridge/pull/17703) fix(explore): deck.gl Multiple chart broken (@stephenLYZ)
- [#17638](https://github.com/kiranbmore0101/bridge/pull/17638) fix(select): select component sort functionality on certain options (@corbinrobb)
- [#17692](https://github.com/kiranbmore0101/bridge/pull/17692) fix(Dashboard): Undefined error in default value in Native Filters (@geido)
- [#17597](https://github.com/kiranbmore0101/bridge/pull/17597) fix: Redirect on 401 (@geido)
- [#17654](https://github.com/kiranbmore0101/bridge/pull/17654) fix: extract tables doesn't work with reserved keywords (@betodealmeida)
- [#17673](https://github.com/kiranbmore0101/bridge/pull/17673) fix(translations): extract messages from js and ts files (@hbruch)
- [#17664](https://github.com/kiranbmore0101/bridge/pull/17664) fix(legacy-plugin-chart-calendar): fix timestamp timezone in Calendar (@kgabryje)
- [#17644](https://github.com/kiranbmore0101/bridge/pull/17644) fix: Allows PUT and DELETE only for owners of dashboard filter state (@michael-s-molina)
- [#17641](https://github.com/kiranbmore0101/bridge/pull/17641) fix(sqla): make text clause escaping optional (@villebro)
- [#17636](https://github.com/kiranbmore0101/bridge/pull/17636) fix: allow for multiple columns in pivot table report (@eschutho)
- [#17612](https://github.com/kiranbmore0101/bridge/pull/17612) fix(dataset): modal sql editor error (@stephenLYZ)
- [#17620](https://github.com/kiranbmore0101/bridge/pull/17620) fix(api): add missing fields to dataset schemas (@villebro)
- [#17618](https://github.com/kiranbmore0101/bridge/pull/17618) fix: Revert "fix(Dashboard): Only apply changes when editing properties" (@geido)
- [#17613](https://github.com/kiranbmore0101/bridge/pull/17613) fix: Dashboard export loading indicator (@michael-s-molina)
- [#17611](https://github.com/kiranbmore0101/bridge/pull/17611) fix: Dashboard API flaky test (@michael-s-molina)
- [#17600](https://github.com/kiranbmore0101/bridge/pull/17600) fix: Ch31968query context (@AAfghahi)
- [#17547](https://github.com/kiranbmore0101/bridge/pull/17547) fix: fix text overflow in toast (@pkdotson)
- [#17542](https://github.com/kiranbmore0101/bridge/pull/17542) fix: Visualizations don't load when using keyboard shortcuts (@michael-s-molina)
- [#17539](https://github.com/kiranbmore0101/bridge/pull/17539) fix(bridge.cli): bridge cli group doesn't support bridge extension app (@ofekisr)
- [#14512](https://github.com/kiranbmore0101/bridge/pull/14512) fix: update kubernetes.mdx (@shicholas)
- [#17527](https://github.com/kiranbmore0101/bridge/pull/17527) fix: RBAC for `can_export` for any resource (@hughhhh)
- [#17555](https://github.com/kiranbmore0101/bridge/pull/17555) fix(lint): remove redis xadd type ignore (@villebro)
- [#17048](https://github.com/kiranbmore0101/bridge/pull/17048) fix(elasticsearch): time_zone setting does not work for cast datetime expressions (@aniaan)
- [#17503](https://github.com/kiranbmore0101/bridge/pull/17503) fix(explore): Metric control breaks when saved metric deleted from dataset (@kgabryje)
- [#17515](https://github.com/kiranbmore0101/bridge/pull/17515) fix(CRUD views): change empty rows layout in TableCollection to be consistent with its headers (@corbinrobb)
- [#15182](https://github.com/kiranbmore0101/bridge/pull/15182) fix: hiding HiddenControl inputs for real, so they don't add height (@rusackas)
- [#17511](https://github.com/kiranbmore0101/bridge/pull/17511) fix: Dashboard access when DASHBOARD_RBAC is disabled (@michael-s-molina)
- [#16799](https://github.com/kiranbmore0101/bridge/pull/16799) fix: Bulk update Spanish translations (@dreglad)
- [#14302](https://github.com/kiranbmore0101/bridge/pull/14302) fix(hive): Update \_latest_partition_from_df in HiveEngineSpec to work on tables with multiple indexes (@codenamelxl)
- [#17458](https://github.com/kiranbmore0101/bridge/pull/17458) fix: Always use temporal type for dttm columns [ID-2] (@kgabryje)
- [#17470](https://github.com/kiranbmore0101/bridge/pull/17470) fix(presto): expand data with null item (@ganczarek)
- [#15254](https://github.com/kiranbmore0101/bridge/pull/15254) fix: feature flags typing (@dpgaspar)
- [#17480](https://github.com/kiranbmore0101/bridge/pull/17480) fix: Update Makefile (@hughhhh)
- [#17471](https://github.com/kiranbmore0101/bridge/pull/17471) fix: create-admin command in Makefile (@hughhhh)
- [#17462](https://github.com/kiranbmore0101/bridge/pull/17462) fix(Dashboard): Save empty label_colors in json_metadata (@geido)
- [#14305](https://github.com/kiranbmore0101/bridge/pull/14305) fix(views/core): iteration over None type (@rasta-rocket)
- [#16566](https://github.com/kiranbmore0101/bridge/pull/16566) fix(docker): add ecpg to docker image (@villebro)
- [#10811](https://github.com/kiranbmore0101/bridge/pull/10811) fix(mssql): week time grain should respect datefirst setting (@binome74)
- [#17440](https://github.com/kiranbmore0101/bridge/pull/17440) fix: should not show migration toast if user not enable dashboard filter components (@graceguo-supercat)
- [#17385](https://github.com/kiranbmore0101/bridge/pull/17385) fix(sql lab): NULL styling in grid cell (@lyndsiWilliams)
- [#12092](https://github.com/kiranbmore0101/bridge/pull/12092) fix: 'DataFrame' object has no attribute 'ix' (@minzhang2110)
- [#17429](https://github.com/kiranbmore0101/bridge/pull/17429) fix: allow POST chart/data request without CSRF token (@etr2460)
- [#16900](https://github.com/kiranbmore0101/bridge/pull/16900) fix(chart): ensure samples data is displayed (@pkdotson)
- [#17426](https://github.com/kiranbmore0101/bridge/pull/17426) fix: Workaround for Pandas Timestamp.isoformat issue (@john-bodley)
- [#17392](https://github.com/kiranbmore0101/bridge/pull/17392) fix(Dashboard): Only apply changes when editing properties (@geido)
- [#17380](https://github.com/kiranbmore0101/bridge/pull/17380) fix(Dashboard): Missing dashboardId when refreshing Explore (@geido)
- [#17106](https://github.com/kiranbmore0101/bridge/pull/17106) fix(dashboard): don't show report modal for anonymous user (@Mayur)
- [#17135](https://github.com/kiranbmore0101/bridge/pull/17135) fix: title case in menus (@Maxime Beauchemin)
- [#17383](https://github.com/kiranbmore0101/bridge/pull/17383) fix: Partial revert of 17236 (@john-bodley)
- [#17348](https://github.com/kiranbmore0101/bridge/pull/17348) fix: Users being able to update datasets across DBs (@hughhhh)
- [#17382](https://github.com/kiranbmore0101/bridge/pull/17382) fix(sqllab): Query limit dropdown number breaks to separate lines (@lyndsiWilliams)
- [#17309](https://github.com/kiranbmore0101/bridge/pull/17309) fix: various typo fixes in MD files (@PApostol)
- [#17370](https://github.com/kiranbmore0101/bridge/pull/17370) fix: failed timezone selector UT (@zhaoyongjie)
- [#17369](https://github.com/kiranbmore0101/bridge/pull/17369) fix: Database selector overflow (@michael-s-molina)
- [#17356](https://github.com/kiranbmore0101/bridge/pull/17356) fix: Remove horizontal scroll navigation from SQL Lab (@etr2460)
- [#17357](https://github.com/kiranbmore0101/bridge/pull/17357) fix(Dashboard): Make color scheme optional (@geido)
- [#17287](https://github.com/kiranbmore0101/bridge/pull/17287) fix(dashboard): Return columns and verbose_map for groupby values of Pivot Table v2 [ID-7] (@kgabryje)
- [#17331](https://github.com/kiranbmore0101/bridge/pull/17331) fix: Show sqllab state when deleting databases (@hughhhh)
- [#17289](https://github.com/kiranbmore0101/bridge/pull/17289) fix: removed redundant logger definition (@gnought)
- [#17236](https://github.com/kiranbmore0101/bridge/pull/17236) fix: revert default series sort-by metric (@john-bodley)
- [#17312](https://github.com/kiranbmore0101/bridge/pull/17312) fix(sqla): Normalize prequery result type (@john-bodley)
- [#17268](https://github.com/kiranbmore0101/bridge/pull/17268) fix: Unable to select None for Alert's log retention (@michael-s-molina)
- [#17228](https://github.com/kiranbmore0101/bridge/pull/17228) fix: remove variables from styled component (@pkdotson)
- [#17200](https://github.com/kiranbmore0101/bridge/pull/17200) fix(Dashboard): Sidepanel positioning (@geido)
- [#17184](https://github.com/kiranbmore0101/bridge/pull/17184) fix(Explore): Remove changes to the properties on cancel (@geido)
- [#17314](https://github.com/kiranbmore0101/bridge/pull/17314) fix: run npm install to fix a bad package version (@eschutho)
- [#17303](https://github.com/kiranbmore0101/bridge/pull/17303) fix: datatable crash when column is empty string [ID-59] (@zhaoyongjie)
- [#17292](https://github.com/kiranbmore0101/bridge/pull/17292) fix: Change 500 error to 422 in Sql Lab (@AAfghahi)
- [#17239](https://github.com/kiranbmore0101/bridge/pull/17239) fix: revert "feat(sqla): apply time grain to all temporal groupbys" (@john-bodley)
- [#17223](https://github.com/kiranbmore0101/bridge/pull/17223) fix(reports): Owners no longer showing undefined in reports (@lyndsiWilliams)
- [#17242](https://github.com/kiranbmore0101/bridge/pull/17242) fix: Updated connection string for Firebolt (@raghavSharmaCode)
- [#17234](https://github.com/kiranbmore0101/bridge/pull/17234) fix(annotations): handle required fields properly (@villebro)
- [#17217](https://github.com/kiranbmore0101/bridge/pull/17217) fix(dashboard): Fix issue #17144 - Resetting native filter form does not clear the values. (@m-ajay)
- [#17221](https://github.com/kiranbmore0101/bridge/pull/17221) fix(Dashboard): Position of the tools of the Tabs component in Edit Dashboard (@geido)
- [#17047](https://github.com/kiranbmore0101/bridge/pull/17047) fix: Allow chart owners to edit title (@belgren)
- [#17205](https://github.com/kiranbmore0101/bridge/pull/17205) fix: reenabling terser plugin for webpack (@rusackas)
- [#17194](https://github.com/kiranbmore0101/bridge/pull/17194) fix: use cache for csv download (@eschutho)
- [#17169](https://github.com/kiranbmore0101/bridge/pull/17169) fix: Order of Select items when unselecting (@michael-s-molina)
- [#17213](https://github.com/kiranbmore0101/bridge/pull/17213) fix: CI is blocked by mypy checking (@zhaoyongjie)
- [#17196](https://github.com/kiranbmore0101/bridge/pull/17196) fix(bigquery): calculated column cannot orderby in BigQuery (@zhaoyongjie)
- [#17195](https://github.com/kiranbmore0101/bridge/pull/17195) fix(sqla): convert prequery results to native python types (@villebro)
- [#17112](https://github.com/kiranbmore0101/bridge/pull/17112) fix: auto refresh interval won't be updated (@yougyoung94)
- [#17046](https://github.com/kiranbmore0101/bridge/pull/17046) fix: dropdown placement for cascading filters popover (@pkdotson)
- [#17166](https://github.com/kiranbmore0101/bridge/pull/17166) fix(explore): timestamp format when copy datatable to clipboard (@kgabryje)
- [#17168](https://github.com/kiranbmore0101/bridge/pull/17168) fix: avoid filters containing null value (@zhaoyongjie)
- [#17155](https://github.com/kiranbmore0101/bridge/pull/17155) fix: preventing sql lab None limit value (@amitmiran137)
- [#17147](https://github.com/kiranbmore0101/bridge/pull/17147) fix: Remove title from the Cancel SVG (@AAfghahi)
- [#17125](https://github.com/kiranbmore0101/bridge/pull/17125) fix: Update package-lock.json of bridge-frontend and cypress-base (@lyndsiWilliams)
- [#17079](https://github.com/kiranbmore0101/bridge/pull/17079) fix(druid): Fix regression with ISO 8601 format (@john-bodley)
- [#17024](https://github.com/kiranbmore0101/bridge/pull/17024) fix(DB Connections): removing paramProperties (@AAfghahi)
- [#17008](https://github.com/kiranbmore0101/bridge/pull/17008) fix: Strict check to allow null values in the SelectControl component (@geido)
- [#16838](https://github.com/kiranbmore0101/bridge/pull/16838) fix: remove duplicate line in docstring (@exemplary-citizen)

**Others**

- [#19732](https://github.com/kiranbmore0101/bridge/pull/19732) chore: Clean redundant dependency from useMemo dep array (@kgabryje)
- [#19636](https://github.com/kiranbmore0101/bridge/pull/19636) chore: skip SIP-68 shadow writing for LTS (@ktmud)
- [#19530](https://github.com/kiranbmore0101/bridge/pull/19530) docs: release notes for 1.5 (@villebro)
- [#19557](https://github.com/kiranbmore0101/bridge/pull/19557) chore: remove redundant adodbapi warning (@villebro)
- [#19481](https://github.com/kiranbmore0101/bridge/pull/19481) chore(plugin-chart-echarts): upgrade echarts 5.3.2 (@villebro)
- [#19392](https://github.com/kiranbmore0101/bridge/pull/19392) test(native filter): add new test for dependent filter (@jinghua-qa)
- [#19417](https://github.com/kiranbmore0101/bridge/pull/19417) refactor: Removes the CSS files from the Heatmap plugin (@michael-s-molina)
- [#19436](https://github.com/kiranbmore0101/bridge/pull/19436) refactor: Removes the CSS files from the Calendar Heatmap plugin (@michael-s-molina)
- [#19439](https://github.com/kiranbmore0101/bridge/pull/19439) chore: Removes hard-coded colors from plugin-chart-pivot-table (@michael-s-molina)
- [#19443](https://github.com/kiranbmore0101/bridge/pull/19443) chore: Removes hard-coded colors from legacy-preset-chart-nvd3 (@michael-s-molina)
- [#19411](https://github.com/kiranbmore0101/bridge/pull/19411) docs: add 1.4.2 changelog entries (@villebro)
- [#19437](https://github.com/kiranbmore0101/bridge/pull/19437) chore: Disables no-literal-colors for the theme configuration (@michael-s-molina)
- [#19424](https://github.com/kiranbmore0101/bridge/pull/19424) chore: attempt to force docs deploy (@srinify)
- [#19412](https://github.com/kiranbmore0101/bridge/pull/19412) chore: update slack invite url (@srinify)
- [#19368](https://github.com/kiranbmore0101/bridge/pull/19368) chore: Removes direct theme imports (@michael-s-molina)
- [#19245](https://github.com/kiranbmore0101/bridge/pull/19245) chore: bump storybook to 6.4.19, migrating config, and linting storybook config (@rusackas)
- [#19239](https://github.com/kiranbmore0101/bridge/pull/19239) chore: Eslint custom plugin to warn about hex and literal colors (@geido)
- [#19390](https://github.com/kiranbmore0101/bridge/pull/19390) docs: Correcting the document font size (@sujiplr)
- [#19387](https://github.com/kiranbmore0101/bridge/pull/19387) chore: add type checking in plugin's test directory (@stephenLYZ)
- [#19365](https://github.com/kiranbmore0101/bridge/pull/19365) chore: add support for npm8 (@villebro)
- [#19350](https://github.com/kiranbmore0101/bridge/pull/19350) docs: update lock + general cleanup (@villebro)
- [#19331](https://github.com/kiranbmore0101/bridge/pull/19331) docs: fix: Use three backticks for code blocks (@kaapstorm)
- [#19320](https://github.com/kiranbmore0101/bridge/pull/19320) chore: add type checking in package tests directory (@stephenLYZ)
- [#19233](https://github.com/kiranbmore0101/bridge/pull/19233) docs: SECRET_KEY Rotation Documentation (@sujiplr)
- [#19323](https://github.com/kiranbmore0101/bridge/pull/19323) chore: bump FAB to 3.4.5 (@dpgaspar)
- [#19322](https://github.com/kiranbmore0101/bridge/pull/19322) ci: add more code owners to helm chart source (@dpgaspar)
- [#19295](https://github.com/kiranbmore0101/bridge/pull/19295) chore: fixing a pluralization typo (@rusackas)
- [#19236](https://github.com/kiranbmore0101/bridge/pull/19236) chore: Make font-weights themable, fix font faces (@kgabryje)
- [#19293](https://github.com/kiranbmore0101/bridge/pull/19293) chore: allow overriding the guest token pyjwt instance (@suddjian)
- [#19161](https://github.com/kiranbmore0101/bridge/pull/19161) chore: add missing keys in components inside lists (@diegomedina248)
- [#18221](https://github.com/kiranbmore0101/bridge/pull/18221) chore: Various docstring fixes (@PApostol)
- [#19270](https://github.com/kiranbmore0101/bridge/pull/19270) docs: update readme.md (@prassanna-helixsense-com)
- [#18648](https://github.com/kiranbmore0101/bridge/pull/18648) chore: update changelog and updating files from 1.4.1 (@eschutho)
- [#19235](https://github.com/kiranbmore0101/bridge/pull/19235) docs: fix broken links in the documentation (@vchrombie)
- [#19172](https://github.com/kiranbmore0101/bridge/pull/19172) chore: use order_desc shared control consistently (@stephenLYZ)
- [#19227](https://github.com/kiranbmore0101/bridge/pull/19227) chore: upgrade mypy check in pre-commit (@ktmud)
- [#19216](https://github.com/kiranbmore0101/bridge/pull/19216) chore: refactor import command (@betodealmeida)
- [#19156](https://github.com/kiranbmore0101/bridge/pull/19156) test: fix TimezoneSelector tests on daylight saving time (@ktmud)
- [#19115](https://github.com/kiranbmore0101/bridge/pull/19115) test(native filter): add new native filter test (@jinghua-qa)
- [#19132](https://github.com/kiranbmore0101/bridge/pull/19132) chore(embedded): refresh the guest token (@suddjian)
- [#19090](https://github.com/kiranbmore0101/bridge/pull/19090) refactor(TimezoneSelector): simplify override logics and tests (@ktmud)
- [#19091](https://github.com/kiranbmore0101/bridge/pull/19091) docs: Modified alerts and reports docs for clarity (@7vikpeculiar)
- [#19077](https://github.com/kiranbmore0101/bridge/pull/19077) perf(dashboard): Send chart requests before native filter requests (@kgabryje)
- [#19064](https://github.com/kiranbmore0101/bridge/pull/19064) perf(dashboard): Improve performance of complex dashboards (@kgabryje)
- [#18950](https://github.com/kiranbmore0101/bridge/pull/18950) chore: Change Sort by and Sort descending controls for Time-series Bar Chart (@geido)
- [#14064](https://github.com/kiranbmore0101/bridge/pull/14064) chore: log multiple errors (@eschutho)
- [#19068](https://github.com/kiranbmore0101/bridge/pull/19068) docs: renamed yugabyte to yugabytedb (@srinify)
- [#19029](https://github.com/kiranbmore0101/bridge/pull/19029) chore: Moves Chart components to src/components folder (@michael-s-molina)
- [#19050](https://github.com/kiranbmore0101/bridge/pull/19050) docs(building): link frontend asset instructions correctly (@cancan101)
- [#19041](https://github.com/kiranbmore0101/bridge/pull/19041) chore(plugin-chart-echarts): bump echarts 5.3.1 (@villebro)
- [#18965](https://github.com/kiranbmore0101/bridge/pull/18965) chore: adding Dutch language translations (NL) (@pablo-guerra)
- [#19032](https://github.com/kiranbmore0101/bridge/pull/19032) chore: Moves CRUD components to the Datasource component (@michael-s-molina)
- [#19042](https://github.com/kiranbmore0101/bridge/pull/19042) chore: Fix deprecated unittest aliases. (@tirkarthi)
- [#18999](https://github.com/kiranbmore0101/bridge/pull/18999) refactor: Deletes the common/components folder (@michael-s-molina)
- [#19021](https://github.com/kiranbmore0101/bridge/pull/19021) chore: change case for upload selection (@pkdotson)
- [#19019](https://github.com/kiranbmore0101/bridge/pull/19019) chore(deps): bump url-parse from 1.5.7 to 1.5.10 in /docs (@dependabot[bot])
- [#18976](https://github.com/kiranbmore0101/bridge/pull/18976) chore(cache): default to SimpleCache in debug mode (@villebro)
- [#18983](https://github.com/kiranbmore0101/bridge/pull/18983) docs: renamed yugabytedb to yugabyte as per request by Yugabyte team (@srinify)
- [#18179](https://github.com/kiranbmore0101/bridge/pull/18179) refactor: converted QueryAutoRefresh to functional component (@briannguyen4)
- [#18922](https://github.com/kiranbmore0101/bridge/pull/18922) chore(deps): bump urijs and xss (@villebro)
- [#18967](https://github.com/kiranbmore0101/bridge/pull/18967) chore(native-filters): Add unit tests for filter cards (@kgabryje)
- [#16860](https://github.com/kiranbmore0101/bridge/pull/16860) chore(security): Remove obsolete FAB metric_access permission (@john-bodley)
- [#18955](https://github.com/kiranbmore0101/bridge/pull/18955) docs: fix sql templating typos (@garyng)
- [#18931](https://github.com/kiranbmore0101/bridge/pull/18931) chore: Moves components out of the commons folder (@michael-s-molina)
- [#18915](https://github.com/kiranbmore0101/bridge/pull/18915) test(Native Filter): User can create parent filters using "Filter is hierarchical (@jinghua-qa)
- [#18811](https://github.com/kiranbmore0101/bridge/pull/18811) chore: add intersect method from backend to fontend for upload extensions (@pkdotson)
- [#18935](https://github.com/kiranbmore0101/bridge/pull/18935) chore: update `UPDATING.md` re: SIP-68 (@betodealmeida)
- [#18866](https://github.com/kiranbmore0101/bridge/pull/18866) refactor(ImportModelsCommand): clean code, extract logic into methods (@michael-hoffman-26)
- [#18850](https://github.com/kiranbmore0101/bridge/pull/18850) test(native filter): add new native filter test for time column filter (@jinghua-qa)
- [#18923](https://github.com/kiranbmore0101/bridge/pull/18923) refactor(docs): clean up deploy of static files (@villebro)
- [#18914](https://github.com/kiranbmore0101/bridge/pull/18914) docs: remove old viz plugin docs (@villebro)
- [#17977](https://github.com/kiranbmore0101/bridge/pull/17977) chore(deps-dev): bump css-loader from 6.2.0 to 6.5.1 in /bridge-frontend (@dependabot[bot])
- [#18882](https://github.com/kiranbmore0101/bridge/pull/18882) docs(Import API): update function description, overwrite real meaning (@michael-hoffman-26)
- [#18854](https://github.com/kiranbmore0101/bridge/pull/18854) chore(tests-backend): migrate snowflake and sqlite to unit tests (@corbinrobb)
- [#18878](https://github.com/kiranbmore0101/bridge/pull/18878) docs: fix toc position scroll bug (#18868) (@michaelzusev)
- [#18861](https://github.com/kiranbmore0101/bridge/pull/18861) docs: add GA conf to config (@villebro)
- [#18820](https://github.com/kiranbmore0101/bridge/pull/18820) chore: npm audit fix in cypress-base (@rusackas)
- [#18828](https://github.com/kiranbmore0101/bridge/pull/18828) chore: unify usages of nvd3 library (@stephenLYZ)
- [#18819](https://github.com/kiranbmore0101/bridge/pull/18819) docs: fix typo in configuring-bridge.mdx (@ardeego)
- [#18824](https://github.com/kiranbmore0101/bridge/pull/18824) docs: add Unvired to INTHEWILD.md (@srinisubramanian)
- [#18818](https://github.com/kiranbmore0101/bridge/pull/18818) docs: add_db_logos (@srinify)
- [#18815](https://github.com/kiranbmore0101/bridge/pull/18815) docs: Added reference and link to configure instructions for docker-compose… (@jacobcroope)
- [#18810](https://github.com/kiranbmore0101/bridge/pull/18810) refactor: move date_parser to unittest (@zhaoyongjie)
- [#18798](https://github.com/kiranbmore0101/bridge/pull/18798) chore(readme): Adding pinot logo into Readme Supported Databases Section (@xiangfu0)
- [#18800](https://github.com/kiranbmore0101/bridge/pull/18800) docs(pinot): Update pinot docs with fixed pinot connection (@xiangfu0)
- [#18805](https://github.com/kiranbmore0101/bridge/pull/18805) chore(deps): bump hosted-git-info from 2.7.1 to 2.8.9 in /bridge-frontend (@dependabot[bot])
- [#18804](https://github.com/kiranbmore0101/bridge/pull/18804) chore(deps): bump url-parse from 1.5.3 to 1.5.7 in /docs (@dependabot[bot])
- [#18801](https://github.com/kiranbmore0101/bridge/pull/18801) chore(FF): adding generic X axis Feature Flag (default: False) (@rusackas)
- [#18142](https://github.com/kiranbmore0101/bridge/pull/18142) refactor: migrate ExploreCtasResultsButton component to typescript (@EugeneTorap)
- [#18761](https://github.com/kiranbmore0101/bridge/pull/18761) chore(deps): bump cached-path-relative from 1.0.2 to 1.1.0 in /bridge-frontend/cypress-base (@dependabot[bot])
- [#18765](https://github.com/kiranbmore0101/bridge/pull/18765) chore(deps): bump y18n from 4.0.0 to 4.0.3 in /bridge-frontend (@dependabot[bot])
- [#18769](https://github.com/kiranbmore0101/bridge/pull/18769) chore(deps): bump ws from 5.2.2 to 5.2.3 in /bridge-frontend (@dependabot[bot])
- [#18779](https://github.com/kiranbmore0101/bridge/pull/18779) refactor: move post_processing to unittest (@zhaoyongjie)
- [#18767](https://github.com/kiranbmore0101/bridge/pull/18767) chore(deps): bump shelljs from 0.8.4 to 0.8.5 in /bridge-frontend (@dependabot[bot])
- [#18764](https://github.com/kiranbmore0101/bridge/pull/18764) chore(deps): bump follow-redirects from 1.14.3 to 1.14.8 in /bridge-frontend (@dependabot[bot])
- [#18762](https://github.com/kiranbmore0101/bridge/pull/18762) chore(deps): bump underscore from 1.12.0 to 1.12.1 in /bridge-frontend (@dependabot[bot])
- [#18772](https://github.com/kiranbmore0101/bridge/pull/18772) chore(deps): bump path-parse from 1.0.6 to 1.0.7 in /bridge-frontend (@dependabot[bot])
- [#18759](https://github.com/kiranbmore0101/bridge/pull/18759) chore(deps): bump shelljs from 0.8.4 to 0.8.5 in /docs (@dependabot[bot])
- [#18760](https://github.com/kiranbmore0101/bridge/pull/18760) chore(deps): bump follow-redirects from 1.14.5 to 1.14.8 in /docs (@dependabot[bot])
- [#18763](https://github.com/kiranbmore0101/bridge/pull/18763) chore(deps): bump nanoid from 3.1.30 to 3.3.1 in /docs (@dependabot[bot])
- [#18766](https://github.com/kiranbmore0101/bridge/pull/18766) chore(deps-dev): bump node-fetch from 2.6.1 to 2.6.7 in /bridge-frontend (@dependabot[bot])
- [#18768](https://github.com/kiranbmore0101/bridge/pull/18768) chore(deps): bump tmpl from 1.0.4 to 1.0.5 in /bridge-frontend (@dependabot[bot])
- [#18770](https://github.com/kiranbmore0101/bridge/pull/18770) chore(deps): bump dns-packet from 1.3.1 to 1.3.4 in /bridge-frontend (@dependabot[bot])
- [#18771](https://github.com/kiranbmore0101/bridge/pull/18771) chore(deps): bump url-parse from 1.4.7 to 1.5.7 in /bridge-frontend (@dependabot[bot])
- [#18629](https://github.com/kiranbmore0101/bridge/pull/18629) chore: move data nav menu to plus menu (@pkdotson)
- [#18705](https://github.com/kiranbmore0101/bridge/pull/18705) chore: bumping caniuse-lite from 1.0.30001257 to 1.0.30001312 (@rusackas)
- [#18728](https://github.com/kiranbmore0101/bridge/pull/18728) chore: use switchboard as dependency for embedded sdk (@suddjian)
- [#18121](https://github.com/kiranbmore0101/bridge/pull/18121) refactor: migrate QueryAndSaveBtns to TypeScript and add stories (@ad-m)
- [#18664](https://github.com/kiranbmore0101/bridge/pull/18664) chore: Remove non-breaking changes from UPDATING.md (@john-bodley)
- [#18707](https://github.com/kiranbmore0101/bridge/pull/18707) chore: updating link to newer viz plugin blog post (@rusackas)
- [#18710](https://github.com/kiranbmore0101/bridge/pull/18710) refactor: decouple pandas postprocessing operator (@zhaoyongjie)
- [#18708](https://github.com/kiranbmore0101/bridge/pull/18708) chore: remove config of temporary_bridge_ui (@zhaoyongjie)
- [#18709](https://github.com/kiranbmore0101/bridge/pull/18709) docs: add docs for viz plugin development (@villebro)
- [#18706](https://github.com/kiranbmore0101/bridge/pull/18706) chore: removing temporary_bridge_ui folder (no longer needed) (@rusackas)
- [#18669](https://github.com/kiranbmore0101/bridge/pull/18669) test(Native filter): add cypress test user can add time grain filter (@jinghua-qa)
- [#18621](https://github.com/kiranbmore0101/bridge/pull/18621) chore: Add craig-rueda as codeowner of Helm Chart (@ad-m)
- [#18136](https://github.com/kiranbmore0101/bridge/pull/18136) refactor: migrate DeleteComponentButton to TypeScript (@Scrip7)
- [#17944](https://github.com/kiranbmore0101/bridge/pull/17944) chore: migrate QueryTable component from jsx to tsx (@MayUWish)
- [#18608](https://github.com/kiranbmore0101/bridge/pull/18608) chore: improve React.useRef etc. import consistency (@ad-m)
- [#18647](https://github.com/kiranbmore0101/bridge/pull/18647) test(native filter): add test for time range filter (@jinghua-qa)
- [#18581](https://github.com/kiranbmore0101/bridge/pull/18581) chore: Update Docusaurus links (@geido)
- [#18120](https://github.com/kiranbmore0101/bridge/pull/18120) refactor: migrate SliderControl to TypeScript & added story (@ad-m)
- [#18657](https://github.com/kiranbmore0101/bridge/pull/18657) chore(docs): add note about quote handling in filters (@villebro)
- [#17939](https://github.com/kiranbmore0101/bridge/pull/17939) refactor(ExploreCtasResultsButton): convert to functional component (@ChristopherCFleming)
- [#18558](https://github.com/kiranbmore0101/bridge/pull/18558) chore: Rename and reposition native filter modal fields (@michael-s-molina)
- [#18143](https://github.com/kiranbmore0101/bridge/pull/18143) refactor: migrate ExploreResultsButton component to FC & tsx (@EugeneTorap)
- [#18200](https://github.com/kiranbmore0101/bridge/pull/18200) chore: upgrade BoundsControl to TS (@ad-m)
- [#18585](https://github.com/kiranbmore0101/bridge/pull/18585) chore: allow sqla docs to use bridgetext (@pkdotson)
- [#18144](https://github.com/kiranbmore0101/bridge/pull/18144) refactor: remove redundant propTypes in ColumnElement (@EugeneTorap)
- [#18600](https://github.com/kiranbmore0101/bridge/pull/18600) docs: fixed URL for contributing landing page (@srinify)
- [#18580](https://github.com/kiranbmore0101/bridge/pull/18580) docs: add password example to dataset import API (@villebro)
- [#17921](https://github.com/kiranbmore0101/bridge/pull/17921) chore(explore): make adhoc columns available without UX BETA ff (@kgabryje)
- [#18574](https://github.com/kiranbmore0101/bridge/pull/18574) chore: update gitignore in the main folder, to hide PyCharm configuration (@michael-hoffman-26)
- [#18568](https://github.com/kiranbmore0101/bridge/pull/18568) chore: Remove outdated roadmap page from Docusaurus (@geido)
- [#18254](https://github.com/kiranbmore0101/bridge/pull/18254) docs(i18n): make translation guide more explicit (@villebro)
- [#18231](https://github.com/kiranbmore0101/bridge/pull/18231) chore: add ci for docs-v2 (@ad-m)
- [#18559](https://github.com/kiranbmore0101/bridge/pull/18559) chore: Update Docusaurus dependencies (@geido)
- [#18229](https://github.com/kiranbmore0101/bridge/pull/18229) chore: Reference Github code in Docusaurus (@geido)
- [#18251](https://github.com/kiranbmore0101/bridge/pull/18251) chore(tests): migrate mssql tests to pytest (@villebro)
- [#18188](https://github.com/kiranbmore0101/bridge/pull/18188) refactor: upgrade ControlHeader to TSX & FC and add storybook (@ad-m)
- [#18230](https://github.com/kiranbmore0101/bridge/pull/18230) chore: Docusaurus throw on broken links (@geido)
- [#18170](https://github.com/kiranbmore0101/bridge/pull/18170) refactor: extract json_required view decorator (@ad-m)
- [#17926](https://github.com/kiranbmore0101/bridge/pull/17926) refactor: sqleditorleftbar to typescript (@JosueLugaro)
- [#18199](https://github.com/kiranbmore0101/bridge/pull/18199) chore: Update links and navigation in Docusaurus (@geido)
- [#18206](https://github.com/kiranbmore0101/bridge/pull/18206) chore: added release notes for 1.4 (@srinify)
- [#18196](https://github.com/kiranbmore0101/bridge/pull/18196) docs(docker compose installation): add pull command to avoid errors when installing bridge using docker compose (@ancasarb)
- [#18160](https://github.com/kiranbmore0101/bridge/pull/18160) chore: move controlPanel into time_table (@zhaoyongjie)
- [#18162](https://github.com/kiranbmore0101/bridge/pull/18162) chore: bump echarts to 5.3.0 (@villebro)
- [#18134](https://github.com/kiranbmore0101/bridge/pull/18134) chore: bump pillow to major version (@eschutho)
- [#18151](https://github.com/kiranbmore0101/bridge/pull/18151) refactor: Moves the Explore form_data endpoint (@michael-s-molina)
- [#18130](https://github.com/kiranbmore0101/bridge/pull/18130) chore: use pkg_resources for cleaner config (@betodealmeida)
- [#18125](https://github.com/kiranbmore0101/bridge/pull/18125) docs: fix typo on security page (@proteusvacuum)
- [#18133](https://github.com/kiranbmore0101/bridge/pull/18133) chore: migrating storybook jsx to typescript #18100 (@jayakrishnankk)
- [#18083](https://github.com/kiranbmore0101/bridge/pull/18083) chore: update changelog and updating for 1.4.0 (@eschutho)
- [#18105](https://github.com/kiranbmore0101/bridge/pull/18105) refactor: migrate RowCountLabel to TypeScript & added story (@ad-m)
- [#18101](https://github.com/kiranbmore0101/bridge/pull/18101) refactor: migrate Checkbox story to TypeScript - see #18100 (@ad-m)
- [#17807](https://github.com/kiranbmore0101/bridge/pull/17807) refactor: sqleditorleftbar to functional (@JosueLugaro)
- [#18082](https://github.com/kiranbmore0101/bridge/pull/18082) chore: split CLI into multiple files (@betodealmeida)
- [#18060](https://github.com/kiranbmore0101/bridge/pull/18060) refactor(example_data): replace the way the birth_names data is loaded to DB (@ofekisr)
- [#17771](https://github.com/kiranbmore0101/bridge/pull/17771) refactor(sql_lab): SQL Lab Persistent Saved State (@AAfghahi)
- [#18059](https://github.com/kiranbmore0101/bridge/pull/18059) chore(plugin-chart-echarts): add types to controls (@villebro)
- [#18058](https://github.com/kiranbmore0101/bridge/pull/18058) chore(supeset.utils.core): move all database utils to database utils module (@ofekisr)
- [#18037](https://github.com/kiranbmore0101/bridge/pull/18037) chore: important change to MakeFile (@AAfghahi)
- [#17569](https://github.com/kiranbmore0101/bridge/pull/17569) chore: column_type_mappings (@dungdm93)
- [#18003](https://github.com/kiranbmore0101/bridge/pull/18003) chore(DatasourceEditor): Create Datasource Legacy Editor Feature Flag (@AAfghahi)
- [#17996](https://github.com/kiranbmore0101/bridge/pull/17996) refactor: remove unused ts-jest (@zhaoyongjie)
- [#17893](https://github.com/kiranbmore0101/bridge/pull/17893) refactor: examples data loading for tests (@ofekisr)
- [#17967](https://github.com/kiranbmore0101/bridge/pull/17967) chore: use new FAB functionality for component schemas update OAS (@dpgaspar)
- [#17979](https://github.com/kiranbmore0101/bridge/pull/17979) chore: reenable lint for test files (@zhaoyongjie)
- [#17965](https://github.com/kiranbmore0101/bridge/pull/17965) refactor: move bridge-ui dependencies to peerDependencies (@zhaoyongjie)
- [#17930](https://github.com/kiranbmore0101/bridge/pull/17930) chore: Move edit dataset lock (@lyndsiWilliams)
- [#17718](https://github.com/kiranbmore0101/bridge/pull/17718) docs(contributing): update contributing section on docs page to match CONTRIBUTING.md (@riahk)
- [#17975](https://github.com/kiranbmore0101/bridge/pull/17975) docs: close bracket on helm chart reference (@brnnnfx)
- [#17971](https://github.com/kiranbmore0101/bridge/pull/17971) chore: bump typescript to 4.5.4, and adjust storybook story. (@rusackas)
- [#17972](https://github.com/kiranbmore0101/bridge/pull/17972) chore: fixing annoying warning about escaping in Emotion styling (@rusackas)
- [#17947](https://github.com/kiranbmore0101/bridge/pull/17947) refactor: import value name from root of bridge-ui/core (@zhaoyongjie)
- [#17959](https://github.com/kiranbmore0101/bridge/pull/17959) chore(deps): bump underscore from 1.12.0 to 1.12.1 in /bridge-frontend (@dependabot[bot])
- [#17958](https://github.com/kiranbmore0101/bridge/pull/17958) chore(deps): bump babel from 2.5.3 to 2.9.1 in /bridge/translations (@dependabot[bot])
- [#17904](https://github.com/kiranbmore0101/bridge/pull/17904) chore(deps): bump @storybook/addon-actions from 6.3.12 to 6.4.9 in /bridge-frontend (@dependabot[bot])
- [#17902](https://github.com/kiranbmore0101/bridge/pull/17902) chore: Moves spec files to the src folder - iteration 10 (@michael-s-molina)
- [#17901](https://github.com/kiranbmore0101/bridge/pull/17901) chore: Moves spec files to the src folder - iteration 9 (@michael-s-molina)
- [#17956](https://github.com/kiranbmore0101/bridge/pull/17956) chore: Adding more viz category mappings for viz picker (@rusackas)
- [#17963](https://github.com/kiranbmore0101/bridge/pull/17963) chore: unbreak pip-compile-multi (@villebro)
- [#17899](https://github.com/kiranbmore0101/bridge/pull/17899) chore: Moves spec files to the src folder - iteration 8 (@michael-s-molina)
- [#17897](https://github.com/kiranbmore0101/bridge/pull/17897) chore: Moves the Menu to views/components folder (@michael-s-molina)
- [#17896](https://github.com/kiranbmore0101/bridge/pull/17896) chore: Moves the hooks folder to the src folder (@michael-s-molina)
- [#17962](https://github.com/kiranbmore0101/bridge/pull/17962) chore(deps): bump urijs from 1.19.6 to 1.19.7 in /bridge-frontend (@dependabot[bot])
- [#17942](https://github.com/kiranbmore0101/bridge/pull/17942) chore: Fix 'button' misspelling in list_with_checkboxes (@acrks)
- [#17860](https://github.com/kiranbmore0101/bridge/pull/17860) chore: remove unused eslintrc (@zhaoyongjie)
- [#17909](https://github.com/kiranbmore0101/bridge/pull/17909) refactor(storybok): upgrade to webpack5 in storybook of plugins (@zhaoyongjie)
- [#17924](https://github.com/kiranbmore0101/bridge/pull/17924) chore: fix misspelling of button (@DavidWoolner)
- [#17782](https://github.com/kiranbmore0101/bridge/pull/17782) ci: make presto hive tests to cover only chartData and sqljson (@amitmiran137)
- [#17717](https://github.com/kiranbmore0101/bridge/pull/17717) chore: Fix UPDATING.md (@john-bodley)
- [#17824](https://github.com/kiranbmore0101/bridge/pull/17824) chore: Help user to find the input fields in the dataset editor (@lyndsiWilliams)
- [#17837](https://github.com/kiranbmore0101/bridge/pull/17837) refactor(monorepo): update plugin dependencies (@zhaoyongjie)
- [#17829](https://github.com/kiranbmore0101/bridge/pull/17829) chore(generator-bridge): migrate to monorepo (@villebro)
- [#17832](https://github.com/kiranbmore0101/bridge/pull/17832) chore: Refactor localstorage into typesafe version (@etr2460)
- [#17811](https://github.com/kiranbmore0101/bridge/pull/17811) other: Add Helm chart option for configOverrides through file (@dd-willgan)
- [#17828](https://github.com/kiranbmore0101/bridge/pull/17828) chore: add lerna version (@zhaoyongjie)
- [#17827](https://github.com/kiranbmore0101/bridge/pull/17827) refactor(monorepo): migrate plugins release workflow (@zhaoyongjie)
- [#17754](https://github.com/kiranbmore0101/bridge/pull/17754) docs: update contribuing docs (@zhaoyongjie)
- [#17650](https://github.com/kiranbmore0101/bridge/pull/17650) chore: updated screenshots in README.md and added recent events (@srinify)
- [#17797](https://github.com/kiranbmore0101/bridge/pull/17797) chore(plugin-chart-table): move adhoc filters control closer to the metrics (@kgabryje)
- [#17798](https://github.com/kiranbmore0101/bridge/pull/17798) chore(plugin-chart-pivot-table): change order of Columns and Rows controls (@kgabryje)
- [#17769](https://github.com/kiranbmore0101/bridge/pull/17769) chore(plugin-chart-pivot-table): migrate react-pivottable into bridge codebase (@kgabryje)
- [#17785](https://github.com/kiranbmore0101/bridge/pull/17785) docs: Fix typo on line 967 (@ChristopherCFleming)
- [#17780](https://github.com/kiranbmore0101/bridge/pull/17780) chore: update fixtures scope that are loading data into the analytical db (@bkyryliuk)
- [#17770](https://github.com/kiranbmore0101/bridge/pull/17770) chore: print test runtime (@bkyryliuk)
- [#17772](https://github.com/kiranbmore0101/bridge/pull/17772) chore: skip flaky tests (@betodealmeida)
- [#17764](https://github.com/kiranbmore0101/bridge/pull/17764) chore: bump react-resize-detector (@villebro)
- [#17723](https://github.com/kiranbmore0101/bridge/pull/17723) chore: bump FAB to 3.4.1 (@dpgaspar)
- [#17698](https://github.com/kiranbmore0101/bridge/pull/17698) refactor(monorepo): change coverage of core to 100% (@zhaoyongjie)
- [#17737](https://github.com/kiranbmore0101/bridge/pull/17737) chore: fixed spelling error on line 1342 of CONTRIBUTING.md (@JosueLugaro)
- [#17735](https://github.com/kiranbmore0101/bridge/pull/17735) chore: fix misspelling of apprear to appear (@jcahela)
- [#17693](https://github.com/kiranbmore0101/bridge/pull/17693) chore(de-translations): Add missing German translations (@hbruch)
- [#17715](https://github.com/kiranbmore0101/bridge/pull/17715) chore: Rename CertifiedIcon to CertifiedBadge (@geido)
- [#17691](https://github.com/kiranbmore0101/bridge/pull/17691) chore: Update TS tasklist script (@etr2460)
- [#17705](https://github.com/kiranbmore0101/bridge/pull/17705) chore: unblock ci on postgres lint (@villebro)
- [#17596](https://github.com/kiranbmore0101/bridge/pull/17596) refactor(monorepo): relocate deckgl to Bridge (@zhaoyongjie)
- [#17689](https://github.com/kiranbmore0101/bridge/pull/17689) chore: convert feature flag tests to unit tests (@betodealmeida)
- [#17687](https://github.com/kiranbmore0101/bridge/pull/17687) chore: removing redundant docker-entrypoint (@ofekisr)
- [#17679](https://github.com/kiranbmore0101/bridge/pull/17679) chore: update babel doc (@zhaoyongjie)
- [#17622](https://github.com/kiranbmore0101/bridge/pull/17622) chore: Remove unreachable return statements (@PApostol)
- [#17605](https://github.com/kiranbmore0101/bridge/pull/17605) docs(exploring-data): add a native filters section to the exploring data docs (@riahk)
- [#17639](https://github.com/kiranbmore0101/bridge/pull/17639) refactor(monorepo): frontend code cleanup after monorepo (@zhaoyongjie)
- [#17631](https://github.com/kiranbmore0101/bridge/pull/17631) chore(de-translations): Add and fix German translations (@hbruch)
- [#17626](https://github.com/kiranbmore0101/bridge/pull/17626) chore(bridge-ui): clean up legacy-plugin-chart-time-table (@ktmud)
- [#17634](https://github.com/kiranbmore0101/bridge/pull/17634) chore(plugin-chart-pivot-table): Add more descriptive tooltips for sorting [ID-29] (@kgabryje)
- [#17606](https://github.com/kiranbmore0101/bridge/pull/17606) refactor: Add AutoSizer to react-virtualized `Grid` (@hughhhh)
- [#17624](https://github.com/kiranbmore0101/bridge/pull/17624) chore: Added unit test to query context change (@AAfghahi)
- [#17623](https://github.com/kiranbmore0101/bridge/pull/17623) chore: Update docstrings in presto.py (@PApostol)
- [#17575](https://github.com/kiranbmore0101/bridge/pull/17575) chore: bumping `polished` package (@rusackas)
- [#17603](https://github.com/kiranbmore0101/bridge/pull/17603) chore: migrate EstimateQueryCostButton component from jsx to tsx (@Damans227)
- [#17516](https://github.com/kiranbmore0101/bridge/pull/17516) docs(exploring-data): various updates to match latest bridge version (@riahk)
- [#17577](https://github.com/kiranbmore0101/bridge/pull/17577) chore: auditing cypress-base dependencies (@rusackas)
- [#17533](https://github.com/kiranbmore0101/bridge/pull/17533) chore(deps-dev): bump @types/jquery from 3.5.8 to 3.5.9 in /bridge-frontend (@dependabot[bot])
- [#17534](https://github.com/kiranbmore0101/bridge/pull/17534) chore(deps-dev): bump @types/enzyme from 3.10.5 to 3.10.10 in /bridge-frontend (@dependabot[bot])
- [#17535](https://github.com/kiranbmore0101/bridge/pull/17535) chore(deps-dev): bump mini-css-extract-plugin from 2.3.0 to 2.4.5 in /bridge-frontend (@dependabot[bot])
- [#17585](https://github.com/kiranbmore0101/bridge/pull/17585) chore: disable merge button (@zhaoyongjie)
- [#17584](https://github.com/kiranbmore0101/bridge/pull/17584) chore: temporarily update .asf.yml (@zhaoyongjie)
- [#17552](https://github.com/kiranbmore0101/bridge/pull/17552) refactor(monorepo): move bridge-ui to bridge(stage 2) (@zhaoyongjie)
- [#17474](https://github.com/kiranbmore0101/bridge/pull/17474) chore: migrate Fieldset component from jsx to tsx (@Damans227)
- [#17556](https://github.com/kiranbmore0101/bridge/pull/17556) chore: bump mysqlclient version (@gnought)
- [#17525](https://github.com/kiranbmore0101/bridge/pull/17525) chore(translations): Add missing i18n (@hbruch)
- [#17562](https://github.com/kiranbmore0101/bridge/pull/17562) chore: Fix deprecated unittest aliases for Python 3.11 compatibility. (@tirkarthi)
- [#17561](https://github.com/kiranbmore0101/bridge/pull/17561) chore: disable merge commit option (@villebro)
- [#17560](https://github.com/kiranbmore0101/bridge/pull/17560) chore: temporarily enable merge in .asf.yml (@zhaoyongjie)
- [#17326](https://github.com/kiranbmore0101/bridge/pull/17326) chore: migrate DragHandle component from jsx to tsx (@Damans227)
- [#17521](https://github.com/kiranbmore0101/bridge/pull/17521) chore: bump major on Pillow, optional dependency (@dpgaspar)
- [#17452](https://github.com/kiranbmore0101/bridge/pull/17452) chore(deps-dev): bump @types/jquery from 3.3.32 to 3.5.8 in /bridge-frontend (@dependabot[bot])
- [#14783](https://github.com/kiranbmore0101/bridge/pull/14783) chore: Slovak translation, enabling language and adding first translations (@minho95)
- [#17453](https://github.com/kiranbmore0101/bridge/pull/17453) chore(deps-dev): bump eslint-import-resolver-webpack from 0.13.1 to 0.13.2 in /bridge-frontend (@dependabot[bot])
- [#17502](https://github.com/kiranbmore0101/bridge/pull/17502) docs(exploring-data): Add upload excel notes (@aniaan)
- [#17522](https://github.com/kiranbmore0101/bridge/pull/17522) chore: remove deprecated selects and deps (@villebro)
- [#17492](https://github.com/kiranbmore0101/bridge/pull/17492) chore: update node version in nvmrc to v16 (@ktmud)
- [#17500](https://github.com/kiranbmore0101/bridge/pull/17500) chore(deps-dev): bump @babel/cli from 7.15.7 to 7.16.0 in /bridge-frontend (@dependabot[bot])
- [#17478](https://github.com/kiranbmore0101/bridge/pull/17478) chore(de-translation): update German translations (based on master) (#17441) (@hbruch)
- [#17501](https://github.com/kiranbmore0101/bridge/pull/17501) chore(translations): fix translation literals (@villebro)
- [#17504](https://github.com/kiranbmore0101/bridge/pull/17504) docs: add dropbox to users list (@exemplary-citizen)
- [#17361](https://github.com/kiranbmore0101/bridge/pull/17361) chore: migrate FormattedNumber component from jsx to tsx (@Damans227)
- [#17509](https://github.com/kiranbmore0101/bridge/pull/17509) refactor(chart.commands): separate commands into two different modules (@ofekisr)
- [#17434](https://github.com/kiranbmore0101/bridge/pull/17434) chore: Slovenian translation update (@dkrat7)
- [#17497](https://github.com/kiranbmore0101/bridge/pull/17497) refactor(QueryContext): separate all processing concerns into QueryContextProcessor (@ofekisr)
- [#17484](https://github.com/kiranbmore0101/bridge/pull/17484) docs: mention that username should be admin to load examples in bridge docs (@jayakrishnankk)
- [#14837](https://github.com/kiranbmore0101/bridge/pull/14837) docs: Update frequently-asked-questions-page.mdx (@kurtiswen)
- [#17496](https://github.com/kiranbmore0101/bridge/pull/17496) refactor(QueryContext): move df methods utils to utils package (@ofekisr)
- [#17495](https://github.com/kiranbmore0101/bridge/pull/17495) refactor(QueryContext): add QueryContextFactory to meet SRP (@ofekisr)
- [#17482](https://github.com/kiranbmore0101/bridge/pull/17482) chore(deps): bump cachelib from 0.1.1 to 0.4.1 (@villebro)
- [#17464](https://github.com/kiranbmore0101/bridge/pull/17464) chore(sql_lab): Added Unit Test for stop query exception (@AAfghahi)
- [#17454](https://github.com/kiranbmore0101/bridge/pull/17454) chore(deps-dev): bump @types/react-loadable from 5.5.4 to 5.5.6 in /bridge-frontend (@dependabot[bot])
- [#17479](https://github.com/kiranbmore0101/bridge/pull/17479) refactor(QueryObject): decouple from bridge (@ofekisr)
- [#17466](https://github.com/kiranbmore0101/bridge/pull/17466) refactor(QueryObject): add QueryObjectFactory to meet SRP (@ofekisr)
- [#17465](https://github.com/kiranbmore0101/bridge/pull/17465) refactor(QueryObject): decouple from queryContext and clean code (@ofekisr)
- [#16868](https://github.com/kiranbmore0101/bridge/pull/16868) chore(fr-translation): update whole French translation (based on 1.3.0 release) (@audour)
- [#17461](https://github.com/kiranbmore0101/bridge/pull/17461) refactor(ChartDataCommand): remove create queryContext command's responsibly (@ofekisr)
- [#17427](https://github.com/kiranbmore0101/bridge/pull/17427) refactor(monorepo): stage 1 (@zhaoyongjie)
- [#17451](https://github.com/kiranbmore0101/bridge/pull/17451) chore: Ignore docs directory for dependabot (@hughhhh)
- [#17398](https://github.com/kiranbmore0101/bridge/pull/17398) test: add native filter default value e2e (@jinghua-qa)
- [#17439](https://github.com/kiranbmore0101/bridge/pull/17439) chore: bumping react syntax highlighter and thusly prismjs (@rusackas)
- [#17422](https://github.com/kiranbmore0101/bridge/pull/17422) chore: Notify user of custom label colors and related Dashboard color scheme (@geido)
- [#14576](https://github.com/kiranbmore0101/bridge/pull/14576) chore(deps): bump hosted-git-info from 2.8.8 to 2.8.9 in /docs (@dependabot[bot])
- [#17438](https://github.com/kiranbmore0101/bridge/pull/17438) chore: bump bridge-ui 0.18.25 (@zhaoyongjie)
- [#17425](https://github.com/kiranbmore0101/bridge/pull/17425) refactor(ChartDataCommand): into two separate commands (@ofekisr)
- [#17407](https://github.com/kiranbmore0101/bridge/pull/17407) refactor(TestChartApi): move chart data api tests into TestChartDataApi (@ofekisr)
- [#17405](https://github.com/kiranbmore0101/bridge/pull/17405) refactor(ChartDataCommand): separate loading query_context form cache into different module (@ofekisr)
- [#17403](https://github.com/kiranbmore0101/bridge/pull/17403) chore: add dependencies for monorepo (@zhaoyongjie)
- [#17400](https://github.com/kiranbmore0101/bridge/pull/17400) refactor(ChartData): move chart_data_apis from ChartRestApi ChartDataRestApi (@ofekisr)
- [#17399](https://github.com/kiranbmore0101/bridge/pull/17399) refactor(ChartData): move ChartDataResult enums to common (@ofekisr)
- [#17350](https://github.com/kiranbmore0101/bridge/pull/17350) docs: add mishmash io to users list (@ntsvetanov)
- [#17387](https://github.com/kiranbmore0101/bridge/pull/17387) docs: Reorder install instructions in CONTRIBUTING.md (@willbarrett)
- [#17367](https://github.com/kiranbmore0101/bridge/pull/17367) chore: bump @typescript-eslint/eslint-plugin to 5.3.0 (@zhaoyongjie)
- [#17362](https://github.com/kiranbmore0101/bridge/pull/17362) chore: bump bridge-ui 0.18.20 (@zhaoyongjie)
- [#17343](https://github.com/kiranbmore0101/bridge/pull/17343) test: add native filter e2e test part3 (@jinghua-qa)
- [#17325](https://github.com/kiranbmore0101/bridge/pull/17325) chore(websocket): bump dependencies (@villebro)
- [#17246](https://github.com/kiranbmore0101/bridge/pull/17246) chore: Test cases for annotations and annotation layers incorrect creation through API (@geido)
- [#17306](https://github.com/kiranbmore0101/bridge/pull/17306) docs: fix numbering on getting started with kubernetes section (@jameskim0987)
- [#17315](https://github.com/kiranbmore0101/bridge/pull/17315) chore: migrate HiddenControl component from jsx to tsx (@Damans227)
- [#17310](https://github.com/kiranbmore0101/bridge/pull/17310) chore: bump bridge-ui to 0.18.18 (@villebro)
- [#17284](https://github.com/kiranbmore0101/bridge/pull/17284) style: remove redundant parentheses from setup.py (@PApostol)
- [#17283](https://github.com/kiranbmore0101/bridge/pull/17283) test: add native filter part2 (@jinghua-qa)
- [#17290](https://github.com/kiranbmore0101/bridge/pull/17290) chore: Bumping pyarrow / pandas (@craig-rueda)
- [#17293](https://github.com/kiranbmore0101/bridge/pull/17293) docs(UPDATING): Adding downtime for #16756 (@exemplary-citizen)
- [#17191](https://github.com/kiranbmore0101/bridge/pull/17191) chore(doc): Update BigQuery Connection database connection UI into doc (@rosemarie-chiu)
- [#17231](https://github.com/kiranbmore0101/bridge/pull/17231) test: added some sanity test for native filter (@jinghua-qa)
- [#17270](https://github.com/kiranbmore0101/bridge/pull/17270) chore: bump bridge-ui to 0.18.17 (@john-bodley)
- [#17266](https://github.com/kiranbmore0101/bridge/pull/17266) chore: bump deckgl 0.4.13 (@zhaoyongjie)
- [#17069](https://github.com/kiranbmore0101/bridge/pull/17069) chore: remove bridgeTheme with withTheme (@pkdotson)
- [#17251](https://github.com/kiranbmore0101/bridge/pull/17251) chore: bump bridge-ui v0.18.16 (@zhaoyongjie)
- [#16950](https://github.com/kiranbmore0101/bridge/pull/16950) other(revert): "fix: the calculated columns explicit type convert into date" (@john-bodley)
- [#17220](https://github.com/kiranbmore0101/bridge/pull/17220) chore: bump Dremio to 1.2.1 (@hughhhh)
- [#17216](https://github.com/kiranbmore0101/bridge/pull/17216) chore: Removes the ChartIcon component (@michael-s-molina)
- [#17232](https://github.com/kiranbmore0101/bridge/pull/17232) chore: bump to bridge-ui 0.18.15 (@zhaoyongjie)
- [#17171](https://github.com/kiranbmore0101/bridge/pull/17171) chore: Add docs to the Select component props (@geido)
- [#17132](https://github.com/kiranbmore0101/bridge/pull/17132) chore: Breaks the dataViewCommon folder into TableCollection and Pagination folders (@michael-s-molina)
- [#17215](https://github.com/kiranbmore0101/bridge/pull/17215) chore: use official isort in pre-commmit (@zhaoyongjie)
- [#17145](https://github.com/kiranbmore0101/bridge/pull/17145) refactor: dashboard->explore url generation (@suddjian)
- [#17130](https://github.com/kiranbmore0101/bridge/pull/17130) chore: Moves the datasource components to the components folder (@michael-s-molina)
- [#17028](https://github.com/kiranbmore0101/bridge/pull/17028) docs: add Symmetrics to users list (@symmetricsfyi)
- [#17151](https://github.com/kiranbmore0101/bridge/pull/17151) chore: update ui packages to 18.14 (@pkdotson)
- [#17146](https://github.com/kiranbmore0101/bridge/pull/17146) chore(druid): No transform without time granularity for consistency (@john-bodley)
- [#17101](https://github.com/kiranbmore0101/bridge/pull/17101) chore(druid): Explicitly cast col to TIMESTAMP (@john-bodley)
- [#17115](https://github.com/kiranbmore0101/bridge/pull/17115) perf(native-filters): Decrease number of unnecessary rerenders in native filters (@kgabryje)
- [#17067](https://github.com/kiranbmore0101/bridge/pull/17067) chore: upgrade highlight.js (@suddjian)
- [#17121](https://github.com/kiranbmore0101/bridge/pull/17121) chore: bump bridge-ui packages to 18.3 (@pkdotson)
- [#17129](https://github.com/kiranbmore0101/bridge/pull/17129) chore: remove redundant po2json dev dependency (@villebro)
- [#17102](https://github.com/kiranbmore0101/bridge/pull/17102) chore: Include codeowners for the Select component (@michael-s-molina)
- [#16911](https://github.com/kiranbmore0101/bridge/pull/16911) test: Cypress 7.0.0 migration (@lyndsiWilliams)
- [#17017](https://github.com/kiranbmore0101/bridge/pull/17017) chore: enable BQ tests (@betodealmeida)
- [#14577](https://github.com/kiranbmore0101/bridge/pull/14577) build(deps): bump lodash from 4.17.19 to 4.17.21 in /docs (@dependabot[bot])
- [#17050](https://github.com/kiranbmore0101/bridge/pull/17050) chore(druid): Standardizing time grain transformations (@john-bodley)
- [#17045](https://github.com/kiranbmore0101/bridge/pull/17045) docs: add vscode linter instructions to CONTRIBUTING.md (@suddjian)
- [#16993](https://github.com/kiranbmore0101/bridge/pull/16993) style: Update text for SLL Tooltip (@gabester78)
- [#16959](https://github.com/kiranbmore0101/bridge/pull/16959) chore(Dashboard): Implement dedicated message for missing dataset (@geido)
- [#17016](https://github.com/kiranbmore0101/bridge/pull/17016) docs(pylint): Add context about disablement of Pylint messages (@john-bodley)
- [#17009](https://github.com/kiranbmore0101/bridge/pull/17009) chore: bump bridge-ui 0.18.10 (@zhaoyongjie)
- [#16974](https://github.com/kiranbmore0101/bridge/pull/16974) refactor(filterset): improve response body (@ofekisr)
- [#16999](https://github.com/kiranbmore0101/bridge/pull/16999) chore: no direct use of bridgeTheme (or bad LESS vars) in SqlEditor (@rusackas)
- [#17000](https://github.com/kiranbmore0101/bridge/pull/17000) chore: removing use of bridgeTheme in favor of ThemeProvider (@rusackas)
- [#16885](https://github.com/kiranbmore0101/bridge/pull/16885) chore: upgrade babel (@suddjian)
- [#16973](https://github.com/kiranbmore0101/bridge/pull/16973) test: update required tests to python 3.8 (@villebro)
- [#16689](https://github.com/kiranbmore0101/bridge/pull/16689) chore: refactor header menu to show in header grid component (@pkdotson)
...
- [#17641](https://github.com/kiranbmore0101/bridge/pull/17641) fix(sqla): make text clause escaping optional (@villebro)
- [#18566](https://github.com/kiranbmore0101/bridge/pull/18566) fix(plugin-chart-echarts): area chart opacity bug (@villebro)
...
- [#17980](https://github.com/kiranbmore0101/bridge/pull/17980) fix: css template API response, less data (@dpgaspar)
- [#17984](https://github.com/kiranbmore0101/bridge/pull/17984) fix: Change default SECRET_KEY, improve docs and banner warning on de… (@dpgaspar)
- [#17981](https://github.com/kiranbmore0101/bridge/pull/17981) fix: API logger output (@dpgaspar)
- [#18006](https://github.com/kiranbmore0101/bridge/pull/18006) fix: SQL Lab sorting of non-numbers (@etr2460)
- [#17573](https://github.com/kiranbmore0101/bridge/pull/17573) fix(sqllab): Floating numbers not sorting correctly in result column (@lyndsiWilliams)
- [#17961](https://github.com/kiranbmore0101/bridge/pull/17961) fix: update slug name (@pkdotson)
- [#17992](https://github.com/kiranbmore0101/bridge/pull/17992) fix: dashboard reload crash (@pkdotson)
- [#18048](https://github.com/kiranbmore0101/bridge/pull/18048) fix(dashboard): scope status of native filter not update (@stephenLYZ)
- [#16869](https://github.com/kiranbmore0101/bridge/pull/16869) fix: handle TIME column serialization (@frafra)
