...
# Release Notes for Bridge 1.3

Bridge 1.3 focuses on hardening and polishing the bridge user experience, with tons of UX improvements and bug fixes focused on charts, dashboards, and the new dashboard-native filters.
