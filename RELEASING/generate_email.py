...
RECEIVER_EMAIL = "dev@bridge.apache.org"
PROJECT_NAME = "Bridge"
PROJECT_MODULE = "bridge"
PROJECT_DESCRIPTION = "Apache Bridge is a modern, enterprise-ready business intelligence web application"
...
@click.group()
@click.pass_context
@click.option("--version", envvar="BRIDGE_VERSION")
@click.option("--version_rc", envvar="BRIDGE_VERSION_RC")
def cli(
    ctx: Context,
    version: str,
    version_rc: str,
...
@click.option(
    ...
    "(see https://lists.apache.org/list.html?dev@bridge.apache.org)",
)
@click.pass_obj
def result_pmc(
